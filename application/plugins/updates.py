...
def _install_registry_package_source(
    ...
    *,
    ...
    from plugin_system.install.package import install_registry_package_under_plugins, registry_package_target
    from plugin_system.requirements.install import install_plugin_requirements_txt
...
def _install_github_plugin_source(
    ...
    *,
    ...
    from plugin_system.requirements.install import install_plugin_requirements_txt
    from plugin_system.registry.download import format_download_error, mark_repo_downloaded, normalize_repo_slug
