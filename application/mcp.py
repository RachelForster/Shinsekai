...
def _mcp_config_response(data: dict[str, Any] | None = None) -> dict[str, Any]:
    from config.persistence.mcp_config import DEFAULT_MCP_CONFIG_PATH, read_mcp_config
...
def _preview_mcp_tools_from_payload(
    ...
    from config.persistence.mcp_config import write_mcp_config
...
def _save_and_apply_mcp_config(
    ...
    from config.persistence.mcp_config import DEFAULT_MCP_CONFIG_PATH, write_mcp_config
