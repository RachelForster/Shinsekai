...
class _DiscoverInstallProgressDialog(QDialog):
    ...
    def __init__(
        ...
        *,
        ...
        self._bytes_lbl.setStyleSheet("color: palette(text);")
        ...
        log_hint.setStyleSheet("color: palette(text);")
...
class PluginSettingsTab(QWidget):
    ...
    def _make_card(
        ...
        if id_show and id_show != name_show:
            ...
            id_lbl.setStyleSheet("color: palette(text);")
        ...
        ver_lbl.setStyleSheet("color: palette(text);")
