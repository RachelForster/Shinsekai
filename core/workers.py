...
from core.app_runtime import get_app_runtime, try_get_app_runtime, tts_emit_to_ui_queue
from core.stream_parser import LlmResponseStreamParser
from core.handler_registry import default_tts_handler_chain, default_ui_output_handler_chain
# --- 抽象 Worker 接口定义 ---
