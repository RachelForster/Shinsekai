...
export function TemplateEditorPage() {
  ...
  const [ruleChangeDialogOpen, setRuleChangeDialogOpen] = useState(false);
  ...
  return (
    <div className="page template-page">
      ...
      <AlertDialog
        body={t("template.ruleChangeDialog.body")}
        cancelLabel={t("common.no")}
        cancelTitle={t("template.ruleChangeDialog.toast")}
        closeLabel={t("common.close")}
        confirmLabel={t("common.yes")}
        onCancel={() => {
          setRuleChangeDialogOpen(false);
          launchMutation.mutate({ resetHistory: false });
        }}
        onClose={() => setRuleChangeDialogOpen(false)}
        onConfirm={() => {
          setRuleChangeDialogOpen(false);
          launchMutation.mutate({ resetHistory: true });
        }}
        open={ruleChangeDialogOpen}
        title={t("template.ruleChangeDialog.title")}
      />
    </div>
  );
}
