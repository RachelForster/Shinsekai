...
export const samplePluginCatalog: PluginCatalogItem[] = [
  {
    ...
    commitSha: "1111111community",
    displayName: "Community State Preview",
    downloadUrl: "https://r2.example.invalid/plugins/community-state-preview/0.1.0/community-state-preview.zip",
    description: "预览 Community 默认状态：插件通过基础 CI 检查，但尚未经过维护者人工复核。",
    downloaded: false,
    entry: "plugins.community_preview.plugin:CommunityPreviewPlugin",
    forks: 1,
    id: "community-state-preview",
    installed: false,
    name: "community_state_preview",
    packageR2Key: "plugins/community-state-preview/0.1.0/community-state-preview.zip",
    packageSha256: "1111111111111111111111111111111111111111111111111111111111111111",
    packageSize: 27648,
    packageSource: "r2",
    packageUrl: "https://r2.example.invalid/plugins/community-state-preview/0.1.0/community-state-preview.zip",
    repo: "shinsekai/plugin-community-preview",
    securityScan: { bandit: { pass: true }, clamav: { pass: true }, pip_audit: { pass: true } },
    sha256: "1111111111111111111111111111111111111111111111111111111111111111",
    lowestShinsekaiVersion: ">=0.2.0",
    shortDescription: "Community badge preview with the default install notice.",
    size: 27648,
    stars: 8,
    tags: ["preview", "community"],
  ...
  {
    author: "Shinsekai Contributors",
    commitSha: "2222222verified",
    displayName: "Verified State Preview",
    downloadUrl: "https://r2.example.invalid/plugins/verified-state-preview/1.0.0/verified-state-preview.zip",
    description: "预览 Verified 状态：维护者已复核源码、依赖、入口和包体元数据。",
    downloaded: false,
    entry: "plugins.verified_preview.plugin:VerifiedPreviewPlugin",
    forks: 4,
    id: "verified-state-preview",
    installed: false,
    name: "verified_state_preview",
    packageR2Key: "plugins/verified-state-preview/1.0.0/verified-state-preview.zip",
    packageSha256: "2222222222222222222222222222222222222222222222222222222222222222",
    packageSize: 43008,
    packageSource: "r2",
    packageUrl: "https://r2.example.invalid/plugins/verified-state-preview/1.0.0/verified-state-preview.zip",
    repo: "shinsekai/plugin-verified-preview",
    review: {
      notes: "Reviewed source, dependencies, entry point, package diff.",
      reviewed_at: "2026-06-06",
      reviewed_by: "Shinsekai Maintainer",
      status: "maintainer_verified",
    },
    securityScan: { bandit: { pass: true }, clamav: { pass: true }, pip_audit: { pass: true } },
    sha256: "2222222222222222222222222222222222222222222222222222222222222222",
    lowestShinsekaiVersion: ">=0.2.0",
    shortDescription: "Verified badge preview with maintainer review metadata.",
    size: 43008,
    stars: 36,
    tags: ["preview", "verified"],
    trustLevel: "verified",
  ...
  {
    author: "Shinsekai Contributors",
    commitSha: "3333333pending",
    displayName: "Pending Review Preview",
    downloadUrl: "https://r2.example.invalid/plugins/pending-review-preview/1.1.0/pending-review-preview.zip",
    description: "预览已验证插件更新后等待复审的状态；卡片仍按 Community 展示，安装弹窗给出更新复审提示。",
    downloaded: false,
    entry: "plugins.pending_review_preview.plugin:PendingReviewPreviewPlugin",
    forks: 2,
    id: "pending-review-preview",
    installed: false,
    name: "pending_review_preview",
    packageR2Key: "plugins/pending-review-preview/1.1.0/pending-review-preview.zip",
    packageSha256: "3333333333333333333333333333333333333333333333333333333333333333",
    packageSize: 38912,
    packageSource: "r2",
    packageUrl: "https://r2.example.invalid/plugins/pending-review-preview/1.1.0/pending-review-preview.zip",
    repo: "shinsekai/plugin-pending-review-preview",
    review: {
      notes: "Previous version was verified. This package version still needs update review.",
    ...
    lowestShinsekaiVersion: ">=0.2.0",
    shortDescription: "Pending review install notice preview.",
    size: 38912,
    stars: 21,
    tags: ["preview", "pending"],
    trustLevel: "verified_update_pending",
    updatedAt: "2026-06-06T01:20:00Z",
    verified: false,
    version: "1.1.0",
  },
  {
