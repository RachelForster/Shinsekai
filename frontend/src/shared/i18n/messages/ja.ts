...
export const jaMessages: Record<MessageKey, string> = {
  ...
  "mediaAutoLabel.action": "Moondreamで未設定画像をタグ付け",
  "mediaAutoLabel.complete": "{annotated}件をタグ付けし、既存{skipped}件を保持、{failed}件が失敗しました。",
  "mediaAutoLabel.error": "Moondreamによる画像タグ付けに失敗しました。",
  "mediaAutoLabel.preparing": "画像タグ付けタスクを準備しています…",
  "mediaAutoLabel.progressTitle": "Moondream タグ付け進捗",
  "mediaAutoLabel.running": "タグ付け中",
