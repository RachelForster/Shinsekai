...
export const jaMessages: Record<MessageKey, string> = {
  ...
  "template.ruleChangeDialog.body": "コンテンツルールの変更が検出されました。クイック再起動しますか？",
  "template.ruleChangeDialog.title": "コンテンツルール変更",
  "template.ruleChangeDialog.toast": "チャットは以前に保存されたルールで続行されます",
