...
export const jaMessages: Record<MessageKey, string> = {
  "desktop.background.panel": "通知パネルを開く",
  "desktop.background.title": "トレイとおやすみ通知",
  ...
  "desktop.background.enabled": "毎日おやすみ通知を送る",
  "desktop.background.time": "通知時刻（端末の時刻）",
  ...
  "desktop.background.test": "通知をテスト",
  "desktop.background.tested": "キャラクターの通知パネルを開きました。毎日の通知には影響しません。",
  "desktop.background.invalidTime": "有効な時刻（00:00–23:59）を入力してください。",
  ...
  "desktop.windowClose.hint": "「システム設定 → トレイとおやすみ通知」で後から変更できます。",
