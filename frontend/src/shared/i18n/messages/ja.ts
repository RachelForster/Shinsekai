...
export const jaMessages: Record<MessageKey, string> = {
  ...
  "desktop.runtime.phase.probing": "管理対象の実行環境をスキャン中",
  ...
  "system.runtime.description": "Shinsekai の管理対象実行環境を確認し、依存関係を修復します。",
  "system.runtime.installLocalAi": "ローカル AI 実行環境をインストール",
  "system.runtime.installMedia": "メディア実行環境をインストール",
  "system.runtime.noCandidates": "管理対象の実行環境候補はまだスキャンされていません。",
  "system.runtime.optionalDescription": "アプリに入った後、メディア処理とローカル AI の依存関係を追加できます。",
  "system.runtime.optionalTitle": "任意の実行環境",
  "system.runtime.scan": "管理対象の実行環境をスキャン",
