...
export const jaMessages: Record<MessageKey, string> = {
  ...
  "mention.empty": "一致するキャラクターがありません",
  "mention.listLabel": "キャラクターをメンション",
  "mention.user": "ユーザー",
  ...
  "template.validation.storyRequired": "先に保存済みストーリーを選択してください。",
  "template.field.playMode": "プレイモード",
  "template.playMode.free": "フリーモード",
  "template.playMode.freeHint": "フリーモードでは、現在の自由会話テンプレートを使います。",
  "template.playMode.openCreator": "ストーリー作成を開く",
  "template.playMode.openEditor": "選択したストーリーを開く",
  "template.playMode.noStories": "保存済みのストーリーはまだありません。先に作成してください。",
  "template.playMode.selectStory": "保存済みストーリー",
  "template.playMode.selectStoryPlaceholder": "保存済みストーリーを選択",
  "template.playMode.story": "ストーリーモード",
  ...
  "story.editor.addNode": "+ ノード",
  "story.editor.addRule": "+ ルールノード",
  "story.editor.addSignal": "+ シグナル",
  "story.editor.addVariable": "+ 変数",
  "story.editor.aiApply": "このパッチを適用",
  "story.editor.aiGenerate": "パッチを生成",
  "story.editor.aiInstruction": "AI 修正の説明",
  "story.editor.aiPlaceholder": "例：既存のノード ID と確定事実を保ったまま、この場面の選択を強める。",
  "story.editor.aiProposal": "候補パッチ：差分 {count} 件、{status}",
  "story.editor.aiTitle": "AI 部分再生成と差分",
  "story.editor.backToGenerator": "← ストーリー生成",
  "story.editor.castEmpty": "なし",
  "story.editor.castMode": "モード",
  "story.editor.castMode.dynamic": "動的候補",
  "story.editor.castMode.fixed": "固定",
  "story.editor.castMode.mixed": "混合",
  "story.editor.castMode.roleBased": "役割駆動",
  "story.editor.castPreview": "キャストをプレビュー",
  "story.editor.castRequired": "固定キャラクター（カンマ区切り）",
  "story.editor.castSelected": "選択中：{ids}",
  "story.editor.castTitle": "キャストと CastPolicy",
  "story.editor.choiceGoto": "選択肢 {index} の行き先",
  "story.editor.choiceLabel": "選択肢 {index} の文言",
  "story.editor.choiceTarget": "行き先ノードを選択",
  "story.editor.choices": "構造化選択肢",
  "story.editor.confidence.high": "高",
  "story.editor.confidence.low": "低",
  "story.editor.confidence.medium": "中",
  "story.editor.commitment": "コミット境界",
  "story.editor.commitment.committed": "確定",
  "story.editor.commitment.draft": "下書き",
  ...
  "story.editor.effectAmount": "効果の増分",
  "story.editor.effectCount": "現在の効果：{count} 件",
  "story.editor.enterCondition": "入場条件",
  "story.editor.enterEffects": "入場効果",
  "story.editor.enterWhen": "変数しきい値（空なら常に入場可）",
  "story.editor.enterWhenPlaceholder": "例：trust.ling >= 10",
  "story.editor.endings": "エンディング試演",
  "story.editor.eyebrow": "STORY CREATOR",
  "story.editor.finalNode": "最終ノード：{id}",
  "story.editor.graphEdges": "グラフ関係",
  "story.editor.graphTitle": "グラフとポート診断",
  "story.editor.loading": "ストーリーを読み込み中…",
  "story.editor.maxActive": "最大同時人数",
  "story.editor.missingId": "ストーリー ID がありません。",
  "story.editor.newChoice": "選択 {index}",
  "story.editor.newScene": "新しい場面 {index}",
  "story.editor.nodeTitle": "タイトル",
  "story.editor.nodeType": "ノード種別",
  "story.editor.nodeType.ending": "エンディング",
  "story.editor.nodeType.story": "ストーリー場面",
  "story.editor.nodes": "ストーリーノード",
  ...
  "story.editor.ruleType": "ルール {index} の種類",
  "story.editor.rules": "ロジックグラフノード",
  "story.editor.selectNode": "ノードを選んで編集を始めてください。",
  "story.editor.selectedNode": "シーンとノード",
  "story.editor.signalId": "シグナル {index} の ID",
  "story.editor.signals": "意味シグナル",
  "story.editor.sourceMap": "ソースマップ",
  "story.editor.step": "ステップ {step} · {action}",
  "story.editor.undo": "元に戻す",
  "story.editor.validate": "公開前検証",
  "story.editor.variableId": "変数 ID",
  "story.editor.variableType.boolean": "真偽",
  "story.editor.variableType.enum": "列挙",
  "story.editor.variableType.integer": "整数",
  "story.editor.variableType.stringSet": "文字列集合",
  "story.editor.variables": "変数",
  "story.editor.variablesTitle": "変数、意味シグナル、ルール",
  "story.editor.validationFailed": "まだ問題があります",
  "story.editor.validationPassed": "検証に合格",
  "story.generator.assumptions": "生成時の仮定",
  "story.generator.assumptionsEmpty": "要件ステージ完了後に表示されます。",
  "story.generator.cancel": "キャンセル",
  "story.generator.castFailures": "キャスト失敗",
  "story.generator.description":
    "LLM が段階ごとに起草し、スキーマ、参照、経路、キャスト、秘密の隔離は決定的コンパイラが判定します。",
  "story.generator.endingCoverage": "エンディング網羅",
  "story.generator.estimatedTokens": "推定トークン",
  ...
  "story.generator.progressMeta": "状態：{status} · 現在のステージ：{stage}",
  "story.generator.regenerate": "再生成",
  "story.generator.regenerateHint": "選択したステージ以降の成果物は無効になり、それ以前の安定成果物は残ります。",
  "story.generator.regenerateStage": "再生成するステージ",
  "story.generator.regenerateTitle": "部分再生成",
  "story.generator.resume": "チェックポイントから再開",
  "story.generator.stage.bible": "ストーリーバイブル",
  "story.generator.stage.characters": "キャラクター責務",
  "story.generator.stage.logic": "ロジックグラフ",
  "story.generator.stage.narrative": "ナラティブグラフ",
  "story.generator.stage.requirements": "要件と仮定",
  "story.generator.stage.resources": "リソース割り当て",
  "story.generator.stage.state": "状態とシグナル",
  "story.generator.start": "生成を開始",
  "story.generator.synopsis": "あらすじ",
  "story.generator.title": "あらすじから実行可能なストーリーを生成",
  "story.generator.validation": "検証サマリー",
