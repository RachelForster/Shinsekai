...
export const jaMessages: Record<MessageKey, string> = {
  ...
  "api.t2i.advanced": "Advanced",
  "api.t2i.apiUrl": "ComfyUI API URL",
  "api.t2i.comfyDir": "ComfyUI folder",
  "api.t2i.description": "Choose how image generation should be prepared for CG moments.",
  "api.t2i.modeCustom": "Custom service",
  "api.t2i.modeCustomHint": "Use another T2I backend or remote endpoint.",
  "api.t2i.modeLocal": "Local ComfyUI",
  "api.t2i.modeLocalHint": "Use the default localhost URL and common node IDs.",
  "api.t2i.modeSkip": "Not now",
  "api.t2i.modeSkipHint": "Leave image generation out of the chat flow.",
  "api.t2i.outputNode": "Output node",
  "api.t2i.promptNode": "Prompt node",
  "api.t2i.provider": "Image engine",
  "api.t2i.quickDefaults": "Fill common defaults",
  ...
  "aiSprites.generateAllImages": "Generate all sprites",
  "aiSprites.generateImage": "Generate sprite",
  "aiSprites.generatePrompts": "Generate prompts",
  "aiSprites.generateSelected": "Generate selected",
  "aiSprites.imageFailed": "Sprite generation failed.",
  "aiSprites.imageGenerated": "Sprite generated.",
  "aiSprites.imageTitle": "Sprite generation",
  ...
  "aiSprites.safeSaveHint": "Generated sprites are reviewed here before being added to the character.",
  "aiSprites.sdPrompt": "SD-style prompt",
  "aiSprites.t2i": "Image engine",
  "aiSprites.tag.angry": "Angry",
  "aiSprites.tag.happy": "Happy",
  ...
  "character.aiSprites.cardBody":
    "Generate SD-style sprite prompts from this character's personality, then create candidates one by one.",
  "character.aiSprites.cardEyebrow": "Prompt agent ready",
  "character.aiSprites.cardTitle": "AI sprite generation",
  "nav.aiSprites": "AI sprites",
