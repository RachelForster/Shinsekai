...
export const jaMessages: Record<MessageKey, string> = {
  ...
  "player.dragHint": "ドラッグかスライダーで顔の位置を調整します。立ち絵を切り替える前に保存してください。",
  "player.x": "横位置",
  "player.y": "縦位置",
  "player.zoom": "拡大率",
  "player.individual": "この立ち絵だけに適用（オフなら人物の既定値として保存）",
  ...
  "reminder.status.active": "通知予定",
  "reminder.futureTime": "未来の通知時刻を選んでください。",
  "reminder.recurrence": "繰り返し",
  "reminder.fieldTime": "次の通知時刻（端末の時刻）",
  "reminder.fieldMessage": "通知内容",
  "reminder.fieldTitle": "予定のタイトル",
  "reminder.character": "通知するキャラクター",
  "reminder.randomHint": "通知のたびに登録済みキャラクターを選び、性格に合わせた台詞と音声を生成します。",
  "reminder.random": "ランダムなキャラクター",
  "reminder.edit": "予定を編集",
  "reminder.delete": "予定を削除",
  "desktop.background.autostartHint":
    "変更はすぐに反映されます。ログイン時に Shinsekai を起動し、予定の確認を再開します。",
  "desktop.background.autostart": "ログイン時に自動起動",
  ...
  "desktop.background.retry": "再読み込み",
  "desktop.windowClose.title": "Shinsekai を閉じますか？",
  "desktop.windowClose.body":
    "トレイに常駐すると、キャラクターから予定の通知を受け取れます。終了するとチャットとすべての通知が停止します。",
  "desktop.windowClose.exit": "アプリを終了",
  "desktop.windowClose.tray": "トレイに最小化",
  "desktop.windowClose.cancel": "キャンセル",
  "desktop.windowClose.remember": "この選択を記憶する",
  "desktop.windowClose.hint": "「システム設定 → トレイと予定」で後から変更できます。",
  "desktop.windowClose.unavailable": "システムトレイを利用できません。キャンセルするか、アプリを終了できます。",
  "desktop.windowClose.behavior": "メインウィンドウを閉じるとき",
  "desktop.windowClose.ask": "毎回確認する",
  "reminder.playVoice": "キャラクター音声を再生",
  "reminder.muteVoice": "通知音声をミュート",
  "reminder.unmuteVoice": "通知音声を有効化",
  "reminder.manage": "通知を管理",
  "reminder.back": "カードに戻る",
  "reminder.previous": "前の通知",
  "reminder.next": "次の通知",
  "reminder.title": "キャラクターの通知",
  "reminder.upcoming": "すべての予定",
  "reminder.inbox": "届いた通知",
  "reminder.empty": "予定はまだありません",
  "reminder.hello": "覚えておくこと、私に任せて。",
  "reminder.hint": "チャットで「10 分後に休憩を教えて」と話しかけてみてください。",
  "reminder.close": "閉じる",
  "reminder.main": "メイン画面",
  "reminder.cancel": "予定を取り消す",
  "reminder.done": "わかった",
  "reminder.crop": "立ち絵の切り抜き",
  "reminder.top": "立ち絵の上部を表示",
  "reminder.once": "一度",
  "reminder.daily": "毎日",
  "reminder.weekly": "毎週",
  "reminder.running": "トレイ常駐中も通知",
  "reminder.load": "読み込み中…",
  "reminder.retry": "再試行",
  "common.loading": "読み込み中…",
  "story.entry": "シナリオメニュー",
  "story.create": "新しいシナリオを作成",
  "story.library": "保存済みシナリオ",
  "story.cancelling": "キャンセル中…",
  "story.cancel": "生成をキャンセル",
  "story.generated": "生成されたシナリオ",
  "story.savedHint": "シナリオを保存しました。今すぐプレイするか、保存済みシナリオから後で再開できます。",
  "story.regenerate.title": "調整して再生成",
  "story.regenerate.hint": "選択した段階とそれ以降を再生成します。それより前の内容は保持されます。",
  "story.regenerate.stage": "再生成する段階",
  ...
  "story.editor.draftHint":
    "ノードを選んで編集。下書きはこのウィンドウに保持されます。AI の提案を採用してから保存してください。",
  "story.editor.brief": "最初の創作要件（作者用）",
  "story.editor.node": "ノード内容",
  "story.editor.nodeTitle": "ノードのタイトル",
  "story.editor.storyTitle": "シナリオ名",
  "story.editor.type": "ノードの種類",
  "story.editor.instruction": "場面の本文・演出指示",
  "story.editor.instructionHint":
    "この場面の出来事、人物の反応、ここで明かせる情報を記述します。プレイ中の LLM が演出に使います。",
  "story.editor.background": "場所のヒント（任意）",
  "story.editor.rounds": "最大会話ラウンド数",
  "story.editor.transitions": "場面の接続",
  "story.editor.target": "遷移先ノード",
  "story.editor.chooseTarget": "遷移先を選択",
  "story.editor.condition": "遷移条件",
  "story.editor.removeEdge": "接続を削除",
  "story.editor.addEdge": "接続を追加",
  "story.editor.defaultTarget": "ラウンド上限時の遷移先",
  "story.editor.none": "なし",
  "story.editor.start": "開始ノード",
  "story.editor.newNode": "新しいノード",
  "story.editor.addNode": "ノードを追加",
  "story.editor.deleteNode": "ノードと関連する接続を削除",
  "story.editor.undo": "元に戻す",
  "story.editor.ai": "LLM による編集",
  "story.editor.aiHint":
    "ノード編集は選択中のノードのみ置換します。グラフ編集ではノードの追加・削除や分岐の変更が可能です。確認して下書きに採用してください。",
  "story.editor.scope": "編集範囲",
  "story.editor.scopeNode": "選択中のノード：{title}",
  "story.editor.scopeGraph": "グラフ全体（新規ノード生成可）",
  "story.editor.request": "修正の要望",
  "story.editor.requestPlaceholder": "例：調査と結末の間に対決の場面を追加し、和解の分岐を作って。",
  "story.editor.suggest": "編集案を生成",
  "story.editor.working": "処理中です…",
  "story.editor.proposal": "変更案を確認",
  "story.editor.added": "追加",
  "story.editor.removed": "削除",
  "story.editor.changed": "変更",
  "story.editor.before": "変更前",
  "story.editor.after": "変更後",
  "story.editor.accept": "下書きに採用",
  "story.editor.discard": "提案を破棄",
  "story.editor.save": "検証して新しいバージョンを保存",
  "story.editor.saved": "新しいバージョンを保存しました。シナリオ一覧から利用できます。",
  "story.editor.play": "新しいバージョンで開始",
  "story.editor.settings": "シナリオ設定",
  "story.editor.settingsHint":
    "この会話は元のシナリオと進行を保持します。エディターでは全体の物語を確認し、新しいバージョンとして保存できます。",
  "story.editor.openFromSettings": "シナリオエディターを開く（先の展開を含む）",
  "story.title": "物語をプレイできるシナリオに",
  "story.description": "人物と背景を選んで新しいシナリオを作成するか、保存済みの物語を続けましょう。",
  "story.setup.title": "人物と背景を選択",
  "story.setup.loadingCharacters": "人物を読み込み中…",
  "story.setup.noCharacters": "人物がまだいません。先に人物ページで作成してください。",
  "story.setup.background": "物語の背景",
  "story.setup.synopsisOptional": "創作要件（任意）",
  "story.setup.synopsis": "創作要件",
  "story.setup.synopsisPlaceholder":
    "ジャンル、葛藤、雰囲気、結末の方向性を記入するか、人物と背景から AI に創作させます。創作用の要件であり、プレイ開始時のプロンプトには直接使いません。",
  "story.setup.generating": "生成中…",
  "story.setup.start": "生成を開始",
  "story.setup.savedHint": "生成後、保存済みシナリオに自動保存されます。",
  "story.launch.action": "シナリオをプレイ",
  "story.launch.busy": "シナリオをプレイする前に、現在のチャットを終了してください。",
  "story.launch.changed": "現在のチャットが変更されました。チャットを終了してから再試行してください。",
  "story.launch.starting": "起動中…",
  "story.enable.loadFirst": "先に設定を読み込んでください",
  "story.enable.action": "シナリオモードを有効にする",
  "story.enable.hint":
    "人物と背景を選んでインタラクティブな物語を作成するか、保存済みシナリオを続けます。生成には設定済みの言語モデルを使用します。",
  "story.enable.loading": "設定を読み込み中…",
  "story.enable.pending": "有効化中…",
  "story.library.loading": "シナリオを読み込み中…",
  "story.library.empty": "プレイできるシナリオがまだありません。新しい物語を作成しましょう。",
  "story.library.characters": "シナリオの人物",
  "story.library.background": "背景：{background}",
  "story.library.progress": "前回の進行状況：{node}",
  "story.library.saved": "保存済み",
  "story.library.unplayed": "未プレイ",
  "story.library.continue": "プレイを再開",
  "story.library.start": "プレイを開始",
  "story.validation.title": "プレイ可否の検証",
  "story.validation.passed": "決定的検証に合格しました",
  "story.validation.stopped": "修正を停止しました。このシナリオはまだ検証に合格していません。",
  "story.validation.repairing": "問題を自動修正中です。検証に合格するとプレイできます。",
  "story.validation.metrics": "到達可能な結末：{coverage}% · 検証済み経路状態：{states}",
  "story.validation.hint": "シナリオのノード生成後、遷移先、人物リソース、結末への経路を検証します。",
  "story.artifact.assumptions": "創作上の仮定",
  "story.artifact.title": "タイトル",
  "story.artifact.premise": "物語の前提",
  "story.artifact.themes": "テーマ",
  "story.artifact.worldRules": "世界のルール",
  "story.artifact.immutableFacts": "確定した事実",
  "story.artifact.secrets": "隠された情報",
  "story.artifact.characters": "人物",
  "story.artifact.name": "名前",
  "story.artifact.responsibility": "物語での役割",
  "story.artifact.personality": "人物設定",
  "story.artifact.description": "説明",
  "story.artifact.setting": "設定",
  "story.artifact.summary": "概要",
  "story.progress.title": "生成の進行状況",
  "story.progress.repairing": " · 検証エラーを修正中",
  "story.recovery.resuming": "保存済みの進行状況から自動再開しています",
  "story.recovery.working": "シナリオを生成し、自動検証しています",
  "story.recovery.correcting": "コンパイルエラーをもとに自動修正しています",
  "story.recovery.waiting": "モデルを一時的に利用できません。自動で再試行し、中断した箇所から再開します",
  "story.recovery.hint": "{status}。手動で再開する必要はありません。ページを離れてもバックグラウンドで処理を続けます。",
  "story.recovery.attempts": "自動復旧：{attempts} 回 · 修正の試行：{repairs} 回",
  "story.recovery.nextRetry": "次の自動再試行：{time}",
  "story.recovery.error": "今回のエラーを表示",
  "story.stage.completed": "完了",
  "story.stage.processing": "処理中",
  "story.stage.waiting": "待機中",
  "story.stage.nodes": "{count} 個のノードを生成しました。下のシナリオ図をご覧ください。",
  "story.stage.details": "段階の全内容を表示",
  "story.stage.loading": "段階の内容を読み込み中…",
  "story.stage.pending": "この段階が完了すると表示されます。",
  "story.stage.foundation": "物語の基礎",
  "story.stage.foundationHint": "世界、対立、隠された情報を決めます",
  "story.stage.characters": "人物一覧",
  "story.stage.charactersHint": "物語の人物と関係を作成します",
  "story.stage.narrative": "シナリオのノード",
  "story.stage.narrativeHint": "各場面、場所、遷移条件を構成します",
  "story.status.queued": "生成待ち",
  "story.status.running": "生成中",
  "story.status.succeeded": "シナリオを生成しました",
  "story.status.failed": "生成が完了していません",
  "story.status.cancelled": "キャンセル済み",
  "story.graph.limited": "ターン制限のある場面",
  "story.graph.free": "自由な会話",
  "story.graph.ending": "結末",
  "story.graph.title": "シナリオ図",
  "story.graph.hint": "ノードを選択すると、場面と遷移条件を確認できます。矢印は次に進める場面を示します。",
  "story.graph.zoom": "図のズーム",
  "story.graph.zoomOut": "縮小",
  "story.graph.zoomReset": "ズームをリセット",
  "story.graph.zoomIn": "拡大",
  "story.graph.region": "シナリオノードの関係図",
  "story.graph.start": "開始 · ",
  "story.graph.details": "ノードの詳細",
  "story.graph.endHint": "物語はここで終わります。",
  "story.graph.location": "場所：{background}",
  "story.graph.rounds": "最大 {count} ターンの会話",
  "story.graph.default": "ターン上限に達した場合の遷移先：{title}",
  "template.workspace.normal": "通常モード",
  "template.workspace.story": "シナリオモード",
  "template.workspace.label": "作成モード",
  ...
  "api.memory.modelDownloadConfirmBody":
    "埋め込みモデルが必要です。今すぐダウンロードしますか？完了後に長期記憶を有効にします。",
  "api.memory.modelDownloadConfirmTitle": "長期記憶モデルをダウンロード",
  "api.memory.modelDownloadFailed": "長期記憶モデルのダウンロードに失敗しました。",
  "api.memory.modelCached": "長期記憶は準備完了です",
  "api.memory.modelMissing": "長期記憶モデルは未ダウンロードです",
  "api.memory.modelStatus": "状態",
  "api.memory.ready": "長期記憶は準備完了です",
  "api.memory.readyCached": "長期記憶は準備完了です",
  "api.memory.recheckModel": "再確認",
  ...
  "api.memory.setupModelMissing": "mem0 準備完了 · モデル未ダウンロード",
  "api.memory.setupReady": "mem0 準備完了 · モデル準備完了",
  "api.memory.statusUnknown": "未確認",
  "api.memory.taskInProgress": "処理中",
  "api.memory.taskVerifying": "埋め込みモデルを確認中…",
  ...
  "api.vision.downloadModel": "モデルをダウンロード",
  "api.vision.downloadingModel": "Moondream モデルをダウンロード中...",
  "api.vision.fetchDone": "{count} 件の Vision モデルを取得しました。",
  "api.vision.fetchEmpty": "利用可能な Vision モデルを取得できませんでした。",
  "api.vision.fetchFailed": "Vision モデル一覧の取得に失敗しました。",
  "api.vision.fetchMissing": "Vision ベース URL を入力してください。リモートサービスには API キーも必要です。",
  "api.vision.fetchModels": "利用可能なモデルを取得",
  "api.vision.fetchTitle": "Vision モデル",
  "api.vision.fetching": "モデルを取得中",
  "api.vision.invalidBaseUrl": "Vision ベース URL に引用符は使用できません。",
  "api.vision.model": "Vision モデル ID",
  "api.vision.modelCached": "Moondream モデルは準備完了です",
  "api.vision.modelDownloadFailed": "Moondream モデルのダウンロードに失敗しました。",
  "api.vision.modelMissing": "Moondream モデルは未ダウンロードです",
  "api.vision.modelPlaceholder": "例: deepseek-flash",
  "api.vision.modelStatus": "ローカルモデル状態",
  ...
  "character.action.aiBrief": "AI で紹介を生成",
  ...
  "character.field.characterBrief": "人物紹介",
  ...
  "character.validation.briefSourceRequired": "先にキャラクター名と人物設定を入力してください。",
  ...
  "character.memory.import": "ファイルから読み込む",
  "character.memory.importBillingNote":
    "表示値は概算です。実際のトークン使用量と料金は、選択したモデル、トークナイザー、モデルの出力長によって変わります。",
  "character.memory.importChunks": "分割とリクエスト",
  "character.memory.importChunksValue": "{chunks} 分割 / 約 {requests} 回のモデルリクエスト",
  "character.memory.importComplete": "長期記憶の読み込みが完了しました",
  "character.memory.importCompleteBody":
    "{extracted} 件を抽出し、{saved} 件を保存、重複 {duplicates} 件をスキップしました。",
  "character.memory.importConfirm": "確認して抽出を開始",
  "character.memory.importDialogue": "プレーン会話",
  "character.memory.importDialogueValue": "{lines} 行 / {characters} 文字",
  "character.memory.importEstimatedInput": "推定入力トークン",
  "character.memory.importEstimatedOutput": "推定出力トークン",
  "character.memory.importEstimatedTotal": "推定合計トークン",
  "character.memory.importFailed": "長期記憶の読み込みに失敗しました",
  "character.memory.importFileDetail": "{kind} · 約 {tokens} トークン · {chunks} 分割",
  "character.memory.importJsonNote":
    "JSON 履歴は「履歴をコピー」と同じプレーン会話形式に変換してから、長さに応じて分割して抽出します。",
  "character.memory.importPickerTitle": "TXT / JSON 履歴ファイルを選択",
  "character.memory.importPreparing": "読み込みタスクを準備中…",
  "character.memory.importPreviewSummary":
    "{files} ファイル、約 {tokens} トークン、{chunks} 分割 / モデルリクエストの見込みです。確認するまで抽出は開始されません。",
  "character.memory.importPreviewTitle": "長期記憶の読み込みプレビュー",
  "character.memory.importRunning": "抽出中…",
  "character.memory.importSourceTokens": "元データのトークン",
  "character.memory.importTaskTitle": "長期記憶を読み込む",
  ...
  "mediaAutoLabel.action": "スマートタグ付け",
  "mediaAutoLabel.complete": "{annotated}件をタグ付けし、既存{skipped}件を保持、{failed}件が失敗しました。",
  "mediaAutoLabel.error": "スマート画像タグ付けに失敗しました。",
  "mediaAutoLabel.preparing": "スマートタグ付けタスクを準備しています…",
  "mediaAutoLabel.progressTitle": "スマートタグ付けの進捗",
  "mediaAutoLabel.running": "スマートタグ付け中",
  ...
  "chat.actionBar.config": "表示設定",
  "chat.actionBar.copy": "コピー",
  "chat.actionBar.branches": "分岐",
  "chat.actionBar.history": "履歴",
  ...
  "chat.config.dialogWidth": "ダイアログ幅",
  "chat.config.dialogWidthCustom": "ダイアログ幅をカスタマイズ",
  "chat.config.dialogWidthValue": "画面幅の {value}%",
  ...
  "chat.init.description": "音声サービスを起動し、長期記憶とチャット環境を準備しています。少々お待ちください。",
  "chat.init.failed": "チャットの準備に失敗しました",
  "chat.init.inProgress": "処理中",
  "chat.init.phase.cancelled": "チャットの準備がキャンセルされました",
  "chat.init.phase.completed": "チャットの準備ができました",
  "chat.init.phase.failed": "チャットの準備に失敗しました",
  "chat.init.phase.finalizing": "チャットの準備を仕上げています",
  "chat.init.phase.memory": "長期記憶を読み込んでいます",
  "chat.init.phase.plugins": "チャット拡張を準備しています",
  "chat.init.phase.preparing": "チャットを準備しています",
  "chat.init.phase.runtime": "チャット環境を起動しています",
  "chat.init.phase.tts": "音声サービスを起動しています",
  "chat.init.title": "チャットを準備中",
  "chat.init.waitingForProgress": "チャット環境からの進捗を待っています…",
  ...
  "chat.input.batch": "まとめる",
  "chat.input.batchCancel": "まとめたメッセージを破棄",
  "chat.input.batchCountdown": "{count}件保留 · {seconds}秒",
  "chat.input.batchSendNow": "まとめたメッセージを今すぐ送信",
  "chat.input.batchWaiting": "{count}件保留 · 入力中",
  "chat.input.interrupt": "中断",
  ...
  "chat.input.attachFile": "ファイル",
  "chat.input.attachImage": "画像",
  "chat.input.attachmentLimit": "1件のメッセージには最大{count}個の添付ファイルを追加できます。",
  "chat.input.attachments": "メッセージの添付ファイル",
  "chat.input.filePickerTitle": "ファイルを添付",
  "chat.input.imagePickerTitle": "画像を添付",
  "chat.input.moreActions": "入力操作をさらに表示",
  "chat.input.placeholder": "台詞を入力",
  "chat.input.removeAttachment": "添付ファイル {name} を削除",
  "chat.input.send": "送信",
  "chat.input.settings": "チャット設定",
  "chat.input.turnControls": "チャット送信コントロール",
  ...
  "chat.theme.customize": "テーマをカスタマイズ",
  "chat.theme.customizer.align": "配置",
  "chat.theme.customizer.back": "テーマ管理に戻る",
  "chat.theme.customizer.background": "背景",
  "chat.theme.customizer.baseTheme": "ベース / 編集テーマ",
  "chat.theme.customizer.borderColor": "境界線の色",
  "chat.theme.customizer.borderRadius": "角丸（CSS 値）",
  "chat.theme.customizer.chrome": "ダイアログ外枠",
  "chat.theme.customizer.cloneHint":
    "内蔵テーマは読み取り専用です。保存時に SVG、フォント、サウンド素材を新しいユーザーテーマへコピーします。",
  "chat.theme.customizer.customName": "{name}・カスタム",
  "chat.theme.customizer.decoration": "ネームプレート装飾",
  "chat.theme.customizer.description":
    "既存テーマを基に Chat UI を調整し、保存前に実際のコンポーネントで確認できます。",
  "chat.theme.customizer.editHint": "ユーザーテーマを編集中です。既存の素材ファイルは保持されます。",
  "chat.theme.customizer.fontFamily": "フォントファミリー",
  "chat.theme.customizer.fontSize": "文字サイズ",
  "chat.theme.customizer.fontWeight": "文字の太さ",
  "chat.theme.customizer.gap": "間隔",
  "chat.theme.customizer.height": "高さ",
  "chat.theme.customizer.idDuplicate": "同じテーマ ID が存在します。別の ID を指定してください。",
  "chat.theme.customizer.idError": "小文字、数字、-、_ のみ使用でき、最大 64 文字です。",
  "chat.theme.customizer.layout": "レイアウト",
  "chat.theme.customizer.loadError": "テーマ設定を読み込めませんでした。",
  "chat.theme.customizer.loading": "テーマ設定を読み込み中…",
  "chat.theme.customizer.maxWidth": "最大幅",
  "chat.theme.customizer.nameError": "テーマ名を入力してください。",
  "chat.theme.customizer.offsetY": "垂直オフセット",
  "chat.theme.customizer.overlap": "ダイアログとの重なり",
  "chat.theme.customizer.padding": "内側の余白",
  "chat.theme.customizer.placement": "配置位置",
  "chat.theme.customizer.preview": "ライブプレビュー",
  "chat.theme.customizer.previewDialog": "会話",
  "chat.theme.customizer.previewHint": "チャット画面と同じテーマ解析とコンポーネントを使用します",
  "chat.theme.customizer.previewName": "桜庭ミオ",
  "chat.theme.customizer.previewOptionOne": "灯りをたどって駅へ向かう",
  "chat.theme.customizer.previewOptions": "選択肢",
  "chat.theme.customizer.previewOptionThree": "ここに残って様子を見る",
  "chat.theme.customizer.previewOptionTwo": "何が起きたのか彼女に聞く",
  "chat.theme.customizer.previewText":
    "夕風がホームを通り抜け、遠い街の灯りがひとつずつ点き始める。今夜は何か特別なことが起こりそうだ。",
  "chat.theme.customizer.reset": "未保存の変更を破棄",
  "chat.theme.customizer.saved": "テーマを保存して適用しました",
  "chat.theme.customizer.saveError": "テーマ設定を保存できませんでした。",
  "chat.theme.customizer.sectionDialog": "ダイアログ",
  "chat.theme.customizer.sectionGlobal": "全体の外観",
  "chat.theme.customizer.sectionInput": "入力エリア",
  "chat.theme.customizer.sectionMetadata": "テーマ情報",
  "chat.theme.customizer.sectionName": "キャラクター名プレート",
  "chat.theme.customizer.sectionOptions": "選択肢ボタン",
  "chat.theme.customizer.sectionTypewriter": "タイプライター",
  "chat.theme.customizer.textColor": "文字色",
  "chat.theme.customizer.themeColor": "テーマカラー",
  "chat.theme.customizer.themeId": "テーマ ID",
  "chat.theme.customizer.title": "Chat UI カスタマイズ",
  "chat.theme.customizer.typewriterSpeed": "表示速度",
  "chat.theme.customizer.version": "バージョン",
  "chat.theme.customizer.width": "幅",
  "chat.theme.customizer.widthMode": "幅モード",
  ...
  "plugin.catalog.downloads": "{count} ダウンロード",
  "plugin.catalog.metadataLabel": "プラグインメタデータ",
  "plugin.catalog.officialPackage": "公式パッケージ",
  "plugin.catalog.securityScanPassed": "スキャン通過",
  "plugin.catalog.sortDownloads": "ダウンロード数",
  "plugin.catalog.sortLabel": "プラグインの並び順",
  "plugin.catalog.sortLatest": "最新アップロード順",
  ...
  "template.primaryCharacters.confirm": "主役・脇役設定を適用",
  "template.primaryCharacters.configure": "主要キャラクターを設定",
  "template.primaryCharacters.count": "主要キャラクター {count} 人 / 全 {total} 人",
  "template.primaryCharacters.description":
    "{count} 人を選択しました。主要キャラクターには完全な設定を、それ以外には紹介文を使用します。紹介文がない場合は AI が生成して保存します。主要キャラクター数に上限はありません。",
  "template.primaryCharacters.hasBrief": "紹介文あり",
  "template.primaryCharacters.modify": "変更",
  "template.primaryCharacters.needsBrief": "紹介文を生成します",
  "template.primaryCharacters.primary": "主要キャラクター",
  "template.primaryCharacters.statusCompact": "主要 {primary} 人・脇役 {secondary} 人",
  "template.primaryCharacters.statusFull": "{count} 人を選択・全員が主要キャラクター",
  "template.primaryCharacters.statusPending": "{count} 人を選択・主役と脇役は未設定",
  "template.primaryCharacters.title": "主要キャラクターを選択",
  "template.primaryCharacters.useAll": "全員を主要キャラクターにする",
  ...
  "template.section.options": "プロンプト設定",
  "template.section.scenario": "ユーザーシナリオ",
  "template.section.system": "システムテンプレート",
  "template.semanticMedia.error": "スマート立ち絵マッチングを初期化できませんでした。",
  "template.semanticMedia.hint":
    "素材 ID をシステムプロンプトに含めず、vibe からベクトルデータベースで立ち絵・シーン・BGM を選びます。",
  "template.semanticMedia.label": "スマート立ち絵マッチング",
  "template.semanticMedia.preparing": "スマート立ち絵マッチングを準備中…",
  ...
  "effect.action.saveImageTags": "画像プロンプトを保存",
  "effect.action.uploadContribution": "エフェクトを投稿",
  "effect.asset.addAudio": "オーディオを追加",
  "effect.asset.batchInsertAudio": "音声を一括挿入",
  "effect.asset.batchInsertAudioComplete": "{count} 枚の画像に音声を設定しました",
