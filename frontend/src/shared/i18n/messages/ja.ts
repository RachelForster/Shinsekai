...
export const jaMessages: Record<MessageKey, string> = {
  ...
  "chat.config.appearanceSession": "現在のセッション",
  "chat.config.appearanceTheme": "アクティブテーマ",
  ...
  "chat.theme.customizer.diagnostic.contrast": "{section}: 文字コントラストは {detail} です（目標 4.5:1）。",
  "chat.theme.customizer.diagnostic.missing-asset": "参照素材が見つかりません: {detail}。",
  "chat.theme.customizer.diagnostic.viewport-overflow": "{section}: {detail} ビューポートであふれる可能性があります。",
  "chat.theme.customizer.diagnosticsReady": "明らかなテーマ問題は見つかりませんでした",
  "chat.theme.customizer.diagnosticsWarning": "テーマ診断に確認が必要です",
  "chat.theme.customizer.previewDialog": "会話",
  "chat.theme.customizer.previewHint": "チャット画面と同じテーマ解析とコンポーネントを使用します",
  "chat.theme.customizer.previewLogLine1": "テーママニフェストを読み込み、検証しました。",
  "chat.theme.customizer.previewLogLine2": "ストリーミング応答は 842 ms で完了しました。",
  "chat.theme.customizer.previewLogLine3": "このターンでは音声フォールバックを使用します。",
  "chat.theme.customizer.previewLogs": "ログ",
  "chat.theme.customizer.previewLogsSearch": "イベント、レベル、ソースを検索",
  ...
  "chat.theme.customizer.previewState": "インタラクション状態",
  "chat.theme.customizer.previewToolbar": "ツールバー",
  ...
  "chat.theme.customizer.previewViewport": "プレビュー表示幅",
  ...
  "chat.theme.customizer.addFont": "フォントを追加",
  "chat.theme.customizer.assetDeleted": "テーマ素材を削除しました",
  "chat.theme.customizer.assetDeleteError": "テーマ素材を削除できませんでした。",
  "chat.theme.customizer.assetListError": "テーマ素材を読み込めませんでした。",
  "chat.theme.customizer.assetPlaceholder": "テーマディレクトリ内の相対パス",
  "chat.theme.customizer.assetSaveFirst": "素材を管理する前にユーザーテーマとして保存してください。",
  "chat.theme.customizer.assetsEmpty": "アップロード済みの素材はありません。",
  "chat.theme.customizer.assetsLoading": "テーマ素材を読み込み中…",
  "chat.theme.customizer.assetUpload": "素材をアップロード",
  "chat.theme.customizer.assetUploadError": "テーマ素材をアップロードできませんでした。",
  "chat.theme.customizer.assetUploaded": "テーマ素材をアップロードしました",
  "chat.theme.customizer.backgroundImage": "背景画像",
  "chat.theme.customizer.boxShadow": "影（CSS 値）",
  "chat.theme.customizer.editorMode": "編集モード",
  "chat.theme.customizer.fieldBackground": "入力欄の内側背景",
  "chat.theme.customizer.fieldRadius": "入力欄の内側角丸",
  "chat.theme.customizer.fontSizeResponsive": "レスポンシブ文字サイズ",
  "chat.theme.customizer.fontSource": "フォント素材パス",
  "chat.theme.customizer.frameImage": "9スライス枠素材",
  "chat.theme.customizer.frameOutset": "枠の外側拡張",
  "chat.theme.customizer.frameSlice": "枠のスライス",
  "chat.theme.customizer.frameWidth": "枠の表示幅",
  "chat.theme.customizer.hideAtStart": "開始選択肢で非表示",
  "chat.theme.customizer.icon": "アイコン",
  "chat.theme.customizer.inherit": "テーマから継承",
  "chat.theme.customizer.inherited": "継承",
  "chat.theme.customizer.level.debug": "デバッグ",
  "chat.theme.customizer.level.default": "既定",
  "chat.theme.customizer.level.error": "エラー",
  "chat.theme.customizer.level.info": "情報",
  "chat.theme.customizer.level.warn": "警告",
  "chat.theme.customizer.logsBadge": "バッジ",
  "chat.theme.customizer.logsCode": "コード表示",
  "chat.theme.customizer.logsDetail": "詳細",
  "chat.theme.customizer.logsEvent": "イベントバッジ",
  "chat.theme.customizer.logsFile": "ファイル項目",
  "chat.theme.customizer.logsLevels": "ログレベル",
  "chat.theme.customizer.logsLine": "ログ行",
  "chat.theme.customizer.logsNumber": "行番号",
  "chat.theme.customizer.logsPage": "ログページ",
  "chat.theme.customizer.logsPanel": "ログパネル",
  "chat.theme.customizer.logsSidebar": "ログサイドバー",
  "chat.theme.customizer.logsSource": "ソースラベル",
  "chat.theme.customizer.logsToolbar": "ログツールバー",
  "chat.theme.customizer.logsViewer": "ログビューア",
  "chat.theme.customizer.minHeight": "最小高さ",
  "chat.theme.customizer.minHeightResponsive": "レスポンシブ最小高さ",
  "chat.theme.customizer.minWidth": "最小幅",
  "chat.theme.customizer.modeAdvanced": "詳細",
  "chat.theme.customizer.modeAdvancedHint": "すべてのテーマトークン、状態、素材、ログ外観を編集します。",
  "chat.theme.customizer.modeBasic": "基本",
  "chat.theme.customizer.modeBasicHint": "よく使う色、文字、レイアウト項目だけを表示します。",
  "chat.theme.customizer.nameClearance": "ネームプレート余白",
  "chat.theme.customizer.nameInputGap": "ネームプレートから入力欄まで",
  "chat.theme.customizer.resetSection": "この項目をリセット",
  "chat.theme.customizer.reveal": "表示方法",
  "chat.theme.customizer.sectionFonts": "カスタムフォント",
  "chat.theme.customizer.sectionLogs": "ログページ",
  "chat.theme.customizer.sectionSend": "送信ボタン",
  "chat.theme.customizer.sectionAssets": "テーマ素材ワークベンチ",
  "chat.theme.customizer.sectionToolbar": "ツールバー",
  "chat.theme.customizer.sendPlacement": "送信ボタン位置",
  "chat.theme.customizer.stateActive": "アクティブ状態",
  "chat.theme.customizer.stateDefault": "通常状態",
  "chat.theme.customizer.stateExpanded": "展開状態",
  "chat.theme.customizer.stateHover": "ホバー状態",
  "chat.theme.customizer.viewportCompact": "コンパクト",
  "chat.theme.customizer.viewportDesktop": "デスクトップ",
  "chat.theme.customizer.viewportMobile": "モバイル",
  "chat.theme.customizer.textShadow": "文字の影",
  "chat.theme.customizer.typewriterSound": "タイプ音",
  "common.redo": "やり直し",
  "common.undo": "元に戻す",
  "chat.theme.error.export": "テーマをエクスポートできませんでした。",
  "chat.theme.export": "テーマを書き出す",
  "chat.theme.exported": "テーマを書き出しました",
