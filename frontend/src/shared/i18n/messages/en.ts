...
export const enMessages: Record<MessageKey, string> = {
  ...
  "mention.empty": "No matching characters",
  "mention.listLabel": "Mention a character",
  "mention.user": "User",
  ...
  "template.validation.storyRequired": "Choose a saved story first.",
  "template.field.playMode": "Play mode",
  "template.playMode.free": "Free mode",
  "template.playMode.freeHint": "Free mode uses the current open-ended chat template.",
  "template.playMode.openCreator": "Open story creator",
  "template.playMode.openEditor": "Open selected story",
  "template.playMode.noStories": "No saved stories yet. Create one first.",
  "template.playMode.selectStory": "Saved story",
  "template.playMode.selectStoryPlaceholder": "Select a saved story",
  "template.playMode.story": "Story mode",
  ...
  "story.editor.addNode": "+ Node",
  "story.editor.addRule": "+ Rule node",
  "story.editor.addSignal": "+ Signal",
  "story.editor.addVariable": "+ Variable",
  "story.editor.aiApply": "Apply this patch",
  "story.editor.aiGenerate": "Generate patch",
  "story.editor.aiInstruction": "AI rewrite notes",
  "story.editor.aiPlaceholder":
    "For example: strengthen this scene's choice while keeping node IDs and committed facts.",
  "story.editor.aiProposal": "Candidate patch: {count} diffs, {status}",
  "story.editor.aiTitle": "AI local rewrite and diffs",
  "story.editor.backToGenerator": "← Story generator",
  "story.editor.castEmpty": "nobody",
  "story.editor.castMode": "Mode",
  "story.editor.castMode.dynamic": "Dynamic",
  "story.editor.castMode.fixed": "Fixed",
  "story.editor.castMode.mixed": "Mixed",
  "story.editor.castMode.roleBased": "Role-based",
  "story.editor.castPreview": "Preview cast",
  "story.editor.castRequired": "Required characters (comma-separated)",
  "story.editor.castSelected": "Selected: {ids}",
  "story.editor.castTitle": "Cast and CastPolicy",
  "story.editor.choiceGoto": "Choice {index} target",
  "story.editor.choiceLabel": "Choice {index} text",
  "story.editor.choiceTarget": "Choose a target node",
  "story.editor.choices": "Structured choices",
  "story.editor.confidence.high": "High",
  "story.editor.confidence.low": "Low",
  "story.editor.confidence.medium": "Medium",
  "story.editor.commitment": "Commitment",
  "story.editor.commitment.committed": "Committed",
  "story.editor.commitment.draft": "Draft",
  ...
  "story.editor.effectAmount": "Effect increment",
  "story.editor.effectCount": "Current effects: {count}",
  "story.editor.enterCondition": "Enter condition",
  "story.editor.enterEffects": "Enter effects",
  "story.editor.enterWhen": "Variable threshold (leave empty to always allow entry)",
  "story.editor.enterWhenPlaceholder": "For example trust.ling >= 10",
  "story.editor.endings": "Ending rehearsals",
  "story.editor.eyebrow": "STORY CREATOR",
  "story.editor.finalNode": "Final node: {id}",
  "story.editor.graphEdges": "Graph relations",
  "story.editor.graphTitle": "Graph and port diagnostics",
  "story.editor.loading": "Loading story…",
  "story.editor.maxActive": "Max active characters",
  "story.editor.missingId": "Missing story ID.",
  "story.editor.newChoice": "Choice {index}",
  "story.editor.newScene": "New scene {index}",
  "story.editor.nodeTitle": "Title",
  "story.editor.nodeType": "Node type",
  "story.editor.nodeType.ending": "Ending",
  "story.editor.nodeType.story": "Story scene",
  "story.editor.nodes": "Story nodes",
  ...
  "story.editor.ruleType": "Rule {index} type",
  "story.editor.rules": "Logic graph nodes",
  "story.editor.selectNode": "Select a node to start editing.",
  "story.editor.selectedNode": "Scene and node",
  "story.editor.signalId": "Signal {index} ID",
  "story.editor.signals": "Semantic signals",
  "story.editor.sourceMap": "Source map",
  "story.editor.step": "Step {step} · {action}",
  "story.editor.undo": "Undo",
  "story.editor.validate": "Validate before publish",
  "story.editor.variableId": "Variable ID",
  "story.editor.variableType.boolean": "Boolean",
  "story.editor.variableType.enum": "Enum",
  "story.editor.variableType.integer": "Integer",
  "story.editor.variableType.stringSet": "String set",
  "story.editor.variables": "Variables",
  "story.editor.variablesTitle": "Variables, semantic signals, and rules",
  "story.editor.validationFailed": "still has issues",
  "story.editor.validationPassed": "passed validation",
  "story.generator.assumptions": "Generation assumptions",
  "story.generator.assumptionsEmpty": "Shown after the requirements stage completes.",
  "story.generator.cancel": "Cancel",
  "story.generator.castFailures": "Cast failures",
  "story.generator.description":
    "The LLM drafts each stage; schema, references, paths, cast, and secret isolation are decided by a deterministic compiler.",
  "story.generator.endingCoverage": "Ending coverage",
  "story.generator.estimatedTokens": "Estimated tokens",
  ...
  "story.generator.progressMeta": "Status: {status} · Current stage: {stage}",
  "story.generator.regenerate": "Regenerate",
  "story.generator.regenerateHint":
    "Artifacts after the selected stage are invalidated; earlier stable artifacts stay.",
  "story.generator.regenerateStage": "Regenerate stage",
  "story.generator.regenerateTitle": "Partial regeneration",
  "story.generator.resume": "Resume from checkpoint",
  "story.generator.stage.bible": "Story bible",
  "story.generator.stage.characters": "Character duties",
  "story.generator.stage.logic": "Logic graph",
  "story.generator.stage.narrative": "Narrative graph",
  "story.generator.stage.requirements": "Requirements",
  "story.generator.stage.resources": "Resource bindings",
  "story.generator.stage.state": "State and signals",
  "story.generator.start": "Start generation",
  "story.generator.synopsis": "Synopsis",
  "story.generator.title": "Generate a playable story from a synopsis",
  "story.generator.validation": "Validation summary",
