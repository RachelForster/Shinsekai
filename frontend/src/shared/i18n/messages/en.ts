...
export const enMessages: Record<MessageKey, string> = {
  ...
  "template.semanticMedia.error": "Could not initialize semantic media matching.",
  ...
  "template.semanticMedia.label": "Semantic vibe matching",
  "template.semanticMedia.preparing": "Preparing semantic matching…",
