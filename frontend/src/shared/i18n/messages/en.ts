...
export const enMessages: Record<MessageKey, string> = {
  ...
  "chat.config.appearanceSession": "Current session",
  "chat.config.appearanceTheme": "Active theme",
  ...
  "chat.theme.customizer.diagnostic.contrast": "{section}: text contrast is only {detail} (target 4.5:1).",
  "chat.theme.customizer.diagnostic.missing-asset": "Missing referenced asset: {detail}.",
  "chat.theme.customizer.diagnostic.viewport-overflow": "{section}: may overflow the {detail} viewport.",
  "chat.theme.customizer.diagnosticsReady": "No obvious theme issues detected",
  "chat.theme.customizer.diagnosticsWarning": "Theme diagnostics need attention",
  ...
  "chat.theme.customizer.previewLogLine1": "Theme manifest loaded and validated.",
  "chat.theme.customizer.previewLogLine2": "Streaming response completed in 842 ms.",
  "chat.theme.customizer.previewLogLine3": "Audio fallback will be used for this turn.",
  "chat.theme.customizer.previewLogs": "Logs",
  "chat.theme.customizer.previewLogsSearch": "Search events, levels, or sources",
  ...
  "chat.theme.customizer.previewState": "Interaction state",
  "chat.theme.customizer.previewToolbar": "Toolbar",
  ...
  "chat.theme.customizer.previewViewport": "Preview viewport",
  ...
  "chat.theme.customizer.addFont": "Add font",
  "chat.theme.customizer.assetDeleted": "Theme asset deleted",
  "chat.theme.customizer.assetDeleteError": "Could not delete the theme asset.",
  "chat.theme.customizer.assetListError": "Could not load theme assets.",
  "chat.theme.customizer.assetPlaceholder": "Relative path inside the theme directory",
  "chat.theme.customizer.assetSaveFirst": "Save as a user theme before uploading or managing assets.",
  "chat.theme.customizer.assetsEmpty": "No custom assets have been uploaded yet.",
  "chat.theme.customizer.assetsLoading": "Loading theme assets…",
  "chat.theme.customizer.assetUpload": "Upload asset",
  "chat.theme.customizer.assetUploadError": "Could not upload the theme asset.",
  "chat.theme.customizer.assetUploaded": "Theme asset uploaded",
  "chat.theme.customizer.backgroundImage": "Background image",
  "chat.theme.customizer.boxShadow": "Shadow (CSS value)",
  "chat.theme.customizer.editorMode": "Editor mode",
  "chat.theme.customizer.fieldBackground": "Inner field background",
  "chat.theme.customizer.fieldRadius": "Inner field radius",
  "chat.theme.customizer.fontSizeResponsive": "Responsive font size",
  "chat.theme.customizer.fontSource": "Font asset path",
  "chat.theme.customizer.frameImage": "Nine-slice frame asset",
  "chat.theme.customizer.frameOutset": "Frame outset",
  "chat.theme.customizer.frameSlice": "Frame slice",
  "chat.theme.customizer.frameWidth": "Frame display width",
  "chat.theme.customizer.hideAtStart": "Hide when start options appear",
  "chat.theme.customizer.icon": "Icon",
  "chat.theme.customizer.inherit": "Inherit from theme",
  "chat.theme.customizer.inherited": "Inherited",
  "chat.theme.customizer.level.debug": "Debug",
  "chat.theme.customizer.level.default": "Default",
  "chat.theme.customizer.level.error": "Error",
  "chat.theme.customizer.level.info": "Info",
  "chat.theme.customizer.level.warn": "Warning",
  "chat.theme.customizer.logsBadge": "Badge",
  "chat.theme.customizer.logsCode": "Code viewer",
  "chat.theme.customizer.logsDetail": "Details",
  "chat.theme.customizer.logsEvent": "Event badge",
  "chat.theme.customizer.logsFile": "File item",
  "chat.theme.customizer.logsLevels": "Log levels",
  "chat.theme.customizer.logsLine": "Log line",
  "chat.theme.customizer.logsNumber": "Line number",
  "chat.theme.customizer.logsPage": "Log page",
  "chat.theme.customizer.logsPanel": "Log panel",
  "chat.theme.customizer.logsSidebar": "Log sidebar",
  "chat.theme.customizer.logsSource": "Source label",
  "chat.theme.customizer.logsToolbar": "Log toolbar",
  "chat.theme.customizer.logsViewer": "Log viewer",
  "chat.theme.customizer.minHeight": "Minimum height",
  "chat.theme.customizer.minHeightResponsive": "Responsive minimum height",
  "chat.theme.customizer.minWidth": "Minimum width",
  "chat.theme.customizer.modeAdvanced": "Advanced",
  "chat.theme.customizer.modeAdvancedHint": "Edit every theme token, state, asset, and log surface.",
  "chat.theme.customizer.modeBasic": "Basic",
  "chat.theme.customizer.modeBasicHint": "Shows the most common color, type, and layout controls.",
  "chat.theme.customizer.nameClearance": "Nameplate clearance",
  "chat.theme.customizer.nameInputGap": "Nameplate to input gap",
  "chat.theme.customizer.resetSection": "Reset section",
  "chat.theme.customizer.reveal": "Reveal behavior",
  "chat.theme.customizer.sectionFonts": "Custom fonts",
  "chat.theme.customizer.sectionLogs": "Log page",
  "chat.theme.customizer.sectionSend": "Send button",
  "chat.theme.customizer.sectionAssets": "Theme asset workbench",
  "chat.theme.customizer.sectionToolbar": "Toolbar",
  "chat.theme.customizer.sendPlacement": "Send button placement",
  "chat.theme.customizer.stateActive": "Active state",
  "chat.theme.customizer.stateDefault": "Default state",
  "chat.theme.customizer.stateExpanded": "Expanded state",
  "chat.theme.customizer.stateHover": "Hover state",
  "chat.theme.customizer.viewportCompact": "Compact",
  "chat.theme.customizer.viewportDesktop": "Desktop",
  "chat.theme.customizer.viewportMobile": "Mobile",
  "chat.theme.customizer.textShadow": "Text shadow",
  "chat.theme.customizer.typewriterSound": "Typing sound",
  "common.redo": "Redo",
  "common.undo": "Undo",
  "chat.theme.error.export": "Could not export the theme.",
  "chat.theme.export": "Export theme",
  "chat.theme.exported": "Theme exported",
