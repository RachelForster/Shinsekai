...
export const enMessages: Record<MessageKey, string> = {
  ...
  "desktop.runtime.phase.probing": "Scanning managed runtimes",
  ...
  "system.runtime.description": "Review the Shinsekai managed runtime and repair its dependencies.",
  "system.runtime.installLocalAi": "Install local AI runtime",
  "system.runtime.installMedia": "Install media runtime",
  "system.runtime.noCandidates": "No managed runtime candidates have been scanned yet.",
  "system.runtime.optionalDescription": "Install media processing and local AI dependencies after entering the app.",
  "system.runtime.optionalTitle": "Optional runtimes",
  "system.runtime.scan": "Scan managed runtime",
