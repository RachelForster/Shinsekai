...
export const enMessages: Record<MessageKey, string> = {
  ...
  "story.setup.synopsisOptional": "Synopsis (optional)",
  "story.setup.synopsis": "Synopsis",
  "story.setup.synopsisPlaceholder":
    "Describe the opening, conflict, or ending, or let AI build a story around your characters and background.",
