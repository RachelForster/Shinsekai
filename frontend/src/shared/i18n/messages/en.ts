...
export const enMessages: Record<MessageKey, string> = {
  "desktop.background.panel": "Open reminder panel",
  "desktop.background.title": "Tray & bedtime reminders",
  ...
  "desktop.background.enabled": "Remind me to sleep every day",
  "desktop.background.time": "Reminder time (local time)",
  ...
  "desktop.background.test": "Test notification",
  "desktop.background.tested": "Character reminder panel opened. The daily reminder is unaffected.",
  "desktop.background.invalidTime": "Enter a valid time (00:00–23:59).",
  ...
  "desktop.windowClose.hint": "Change this later in System settings → Tray & bedtime reminders.",
