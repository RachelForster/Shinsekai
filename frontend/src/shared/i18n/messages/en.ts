...
export const enMessages: Record<MessageKey, string> = {
  ...
  "reminder.status.active": "Scheduled",
  "reminder.futureTime": "Choose a future reminder time.",
  "reminder.recurrence": "Repeat",
  "reminder.fieldTime": "Next reminder (local time)",
  "reminder.fieldMessage": "Reminder content",
  "reminder.fieldTitle": "Title",
  "reminder.character": "Character",
  "reminder.randomHint":
    "A random configured character is selected for each occurrence, with dialogue and voice matching that character.",
  "reminder.random": "Random character",
  "reminder.edit": "Edit reminder",
  "reminder.delete": "Delete reminder",
  "desktop.background.autostartHint":
    "Changes apply immediately. Shinsekai starts at login and resumes checking schedules.",
  "desktop.background.autostart": "Start when I sign in",
  ...
  "desktop.background.retry": "Reload",
  "desktop.windowClose.title": "Close Shinsekai?",
  "desktop.windowClose.body":
    "Keep running in the tray to receive scheduled character reminders. Quitting stops chats and all reminders.",
  "desktop.windowClose.exit": "Quit app",
  "desktop.windowClose.tray": "Minimize to tray",
  "desktop.windowClose.cancel": "Cancel",
  "desktop.windowClose.remember": "Remember my choice",
  "desktop.windowClose.hint": "Change this later in System settings → Tray & schedules.",
  "desktop.windowClose.unavailable": "The system tray is unavailable. You can cancel or quit the app.",
  "desktop.windowClose.behavior": "When closing the main window",
  "desktop.windowClose.ask": "Ask every time",
  "reminder.playVoice": "Play character voice",
  "reminder.muteVoice": "Mute reminders",
  "reminder.unmuteVoice": "Unmute reminders",
  "reminder.manage": "Manage reminders",
  "reminder.back": "Back to card",
  "reminder.previous": "Previous reminder",
  "reminder.next": "Next reminder",
  "reminder.title": "Character reminders",
  "reminder.upcoming": "All schedules",
  "reminder.inbox": "Received",
  "reminder.empty": "No reminders scheduled",
  "reminder.hello": "Leave the little reminders to me.",
  "reminder.hint": "Try saying “Remind me to rest in ten minutes” in chat.",
  "reminder.close": "Hide",
  "reminder.main": "Open app",
  "reminder.cancel": "Cancel reminder",
  "reminder.done": "Got it",
  "reminder.crop": "Portrait crop",
  "reminder.top": "Show top of portrait",
  "reminder.once": "Once",
  "reminder.daily": "Daily",
  "reminder.weekly": "Weekly",
  "reminder.running": "Active while in the tray",
  "reminder.load": "Loading…",
  "reminder.retry": "Retry",
  "common.loading": "Loading…",
  "story.entry": "Story workspace",
  "story.create": "Create a story",
  "story.library": "Saved stories",
  "story.cancelling": "Cancelling…",
  "story.cancel": "Cancel generation",
  "story.generated": "Generated story",
  "story.savedHint": "Your story is saved. Play now or continue later from Saved stories.",
  "story.regenerate.title": "Revise and regenerate",
  "story.regenerate.hint": "Regenerate the selected stage and all later stages. Earlier content will be kept.",
  "story.regenerate.stage": "Stage to regenerate",
  ...
  "story.editor.draftHint":
    "Select a node to edit. Drafts are kept in this window. Accept an AI proposal before saving.",
  "story.editor.brief": "Original creative brief (author context)",
  "story.editor.node": "Node content",
  "story.editor.nodeTitle": "Node title",
  "story.editor.storyTitle": "Story title",
  "story.editor.type": "Node type",
  "story.editor.instruction": "Scene text / performance guidance",
  "story.editor.instructionHint":
    "Describe what happens here, how characters react, and what may be revealed at this node. The playing LLM uses this guidance.",
  "story.editor.background": "Location hint (optional)",
  "story.editor.rounds": "Maximum dialogue rounds",
  "story.editor.transitions": "Story connections",
  "story.editor.target": "Target node",
  "story.editor.chooseTarget": "Choose a target node",
  "story.editor.condition": "Transition condition",
  "story.editor.removeEdge": "Remove connection",
  "story.editor.addEdge": "Add connection",
  "story.editor.defaultTarget": "Default destination at round limit",
  "story.editor.none": "None",
  "story.editor.start": "Starting node",
  "story.editor.newNode": "New node",
  "story.editor.addNode": "Add node",
  "story.editor.deleteNode": "Delete node and its connections",
  "story.editor.undo": "Undo",
  "story.editor.ai": "Edit with an LLM",
  "story.editor.aiHint":
    "A node edit replaces only the selected node. A graph edit can add or remove nodes and change branches. Review and accept the result into your draft.",
  "story.editor.scope": "Edit scope",
  "story.editor.scopeNode": "Selected node: {title}",
  "story.editor.scopeGraph": "Whole graph (can generate new nodes)",
  "story.editor.request": "Revision request",
  "story.editor.requestPlaceholder": "For example: add a confrontation before the ending and a reconciliation branch.",
  "story.editor.suggest": "Generate proposal",
  "story.editor.working": "Working, please wait…",
  "story.editor.proposal": "Review proposed changes",
  "story.editor.added": "Added",
  "story.editor.removed": "Removed",
  "story.editor.changed": "Changed",
  "story.editor.before": "Before",
  "story.editor.after": "After",
  "story.editor.accept": "Accept into draft",
  "story.editor.discard": "Discard proposal",
  "story.editor.save": "Validate and save new version",
  "story.editor.saved": "New version saved and available in the story library.",
  "story.editor.play": "Start playing the new version",
  "story.editor.settings": "Story settings",
  "story.editor.settingsHint":
    "This conversation keeps its original story and progress. The editor shows the full plot and saves revisions as new versions.",
  "story.editor.openFromSettings": "Open story editor (includes later plot)",
  "story.title": "Turn your story into a playable adventure",
  "story.description": "Choose characters and a background to create a story, or continue a saved one.",
  "story.setup.title": "Choose characters and a background",
  "story.setup.loadingCharacters": "Loading characters…",
  "story.setup.noCharacters": "No characters yet. Create some on the Characters page first.",
  "story.setup.background": "Story background",
  "story.setup.synopsisOptional": "Creative brief (optional)",
  "story.setup.synopsis": "Creative brief",
  "story.setup.synopsisPlaceholder":
    "Describe the genre, conflict, tone, or ending, or let AI create from the cast and setting. This brief guides authoring; it is not the opening prompt used during play.",
  "story.setup.generating": "Generating…",
  "story.setup.start": "Generate story",
  "story.setup.savedHint": "Generated stories are saved automatically in Saved stories.",
  "story.launch.action": "Play story",
  "story.launch.busy": "End the current chat before playing a story.",
  "story.launch.changed": "The current chat has changed. End it before trying again.",
  "story.launch.starting": "Starting…",
  "story.enable.loadFirst": "Load settings first",
  "story.enable.action": "Enable story mode",
  "story.enable.hint":
    "Choose characters and a background to create an interactive story, or continue a saved one. Generation uses your configured language model.",
  "story.enable.loading": "Loading settings…",
  "story.enable.pending": "Enabling…",
  "story.library.loading": "Loading stories…",
  "story.library.empty": "No playable stories yet. Create your first story.",
  "story.library.characters": "Story characters",
  "story.library.background": "Background: {background}",
  "story.library.progress": "Last progress: {node}",
  "story.library.saved": "Saved",
  "story.library.unplayed": "Not started yet",
  "story.library.continue": "Continue playing",
  "story.library.start": "Start playing",
  "story.validation.title": "Playability check",
  "story.validation.passed": "Passed deterministic validation",
  "story.validation.stopped": "Repairs stopped. This story has not passed validation.",
  "story.validation.repairing": "Fixing issues automatically. You can play once validation passes.",
  "story.validation.metrics": "Reachable endings: {coverage}% · Path states checked: {states}",
  "story.validation.hint":
    "After generating story nodes, transition targets, character resources, and paths to endings will be checked.",
  "story.artifact.assumptions": "Creative assumptions",
  "story.artifact.title": "Title",
  "story.artifact.premise": "Premise",
  "story.artifact.themes": "Themes",
  "story.artifact.worldRules": "World rules",
  "story.artifact.immutableFacts": "Established facts",
  "story.artifact.secrets": "Hidden information",
  "story.artifact.characters": "Characters",
  "story.artifact.name": "Name",
  "story.artifact.responsibility": "Story role",
  "story.artifact.personality": "Character profile",
  "story.artifact.description": "Description",
  "story.artifact.setting": "Setting",
  "story.artifact.summary": "Summary",
  "story.progress.title": "Generation progress",
  "story.progress.repairing": " · Fixing validation issues",
  "story.recovery.resuming": "Automatically resuming from saved progress",
  "story.recovery.working": "Generating and automatically checking the story",
  "story.recovery.correcting": "Automatically correcting compilation errors",
  "story.recovery.waiting": "The model is temporarily unavailable. Generation will retry and resume automatically",
  "story.recovery.hint":
    "{status}. No manual action is needed; processing continues in the background when you leave this page.",
  "story.recovery.attempts": "Automatic resumptions: {attempts} · Repair attempts: {repairs}",
  "story.recovery.nextRetry": "Next automatic retry: {time}",
  "story.recovery.error": "View this error",
  "story.stage.completed": "Completed",
  "story.stage.processing": "Processing",
  "story.stage.waiting": "Waiting",
  "story.stage.nodes": "Nodes generated: {count}. See the story graph below.",
  "story.stage.details": "View full stage content",
  "story.stage.loading": "Loading stage content…",
  "story.stage.pending": "Available when this stage is complete.",
  "story.stage.foundation": "Story foundation",
  "story.stage.foundationHint": "Define the world, conflict, and hidden information",
  "story.stage.characters": "Character list",
  "story.stage.charactersHint": "Create the characters and their relationships",
  "story.stage.narrative": "Story nodes",
  "story.stage.narrativeHint": "Arrange scenes, locations, and transition conditions",
  "story.status.queued": "Queued for generation",
  "story.status.running": "Generating",
  "story.status.succeeded": "Story generated",
  "story.status.failed": "Generation incomplete",
  "story.status.cancelled": "Cancelled",
  "story.graph.limited": "Turn-limited scene",
  "story.graph.free": "Free conversation",
  "story.graph.ending": "Ending",
  "story.graph.title": "Story graph",
  "story.graph.hint":
    "Select a node to view its scene and transition conditions. Arrows show the next possible scenes.",
  "story.graph.zoom": "Graph zoom",
  "story.graph.zoomOut": "Zoom out",
  "story.graph.zoomReset": "Reset zoom",
  "story.graph.zoomIn": "Zoom in",
  "story.graph.region": "Story node connections",
  "story.graph.start": "Start · ",
  "story.graph.details": "Node details",
  "story.graph.endHint": "The story ends here.",
  "story.graph.location": "Location: {background}",
  "story.graph.rounds": "Maximum conversation turns: {count}",
  "story.graph.default": "At the turn limit, continue to: {title}",
  "template.workspace.normal": "Normal mode",
  "template.workspace.story": "Story mode",
  "template.workspace.label": "Creation mode",
  ...
  "api.memory.modelDownloadConfirmBody":
    "The embedding model is required. Download it now? Long-term memory will be enabled when it finishes.",
  "api.memory.modelDownloadConfirmTitle": "Download long-term memory model",
  "api.memory.modelDownloadFailed": "Failed to download the long-term memory model.",
  "api.memory.modelCached": "Long-term memory is ready",
  "api.memory.modelMissing": "Long-term memory model not downloaded",
  "api.memory.modelMissingKeepOff": "Long-term memory model not downloaded",
  "api.memory.modelStatus": "Status",
  "api.memory.ready": "Long-term memory is ready",
  "api.memory.readyCached": "Long-term memory is ready",
  "api.memory.recheckModel": "Check again",
  ...
  "api.memory.setupModelMissing": "mem0 is ready · Model not downloaded",
  "api.memory.setupReady": "mem0 is ready · Model is ready",
  "api.memory.statusUnknown": "Not checked",
  "api.memory.taskInProgress": "In progress",
  "api.memory.taskVerifying": "Verifying embedding model...",
  ...
  "api.vision.downloadModel": "Download model",
  "api.vision.downloadingModel": "Downloading the Moondream model...",
  "api.vision.fetchDone": "Loaded {count} vision models.",
  "api.vision.fetchEmpty": "No available vision models were returned.",
  "api.vision.fetchFailed": "Could not fetch the vision model list.",
  "api.vision.fetchMissing": "Enter the vision base URL and, for remote services, an API key.",
  "api.vision.fetchModels": "Fetch available models",
  "api.vision.fetchTitle": "Vision models",
  "api.vision.fetching": "Fetching models",
  "api.vision.invalidBaseUrl": "The vision base URL cannot contain quotes.",
  "api.vision.model": "Vision model ID",
  "api.vision.modelCached": "Moondream model is ready",
  "api.vision.modelDownloadFailed": "Failed to download the Moondream model.",
  "api.vision.modelMissing": "Moondream model not downloaded",
  "api.vision.modelPlaceholder": "e.g. deepseek-flash",
  ...
  "character.action.aiBrief": "Generate brief",
  ...
  "character.field.characterBrief": "Character brief",
  ...
  "character.validation.briefSourceRequired": "Enter a character name and setting first.",
  ...
  "character.memory.import": "Import from files",
  "character.memory.importBillingNote":
    "These are estimates. Actual token usage and cost vary with the selected model, tokenizer, and model output length.",
  "character.memory.importChunks": "Chunks and requests",
  "character.memory.importChunksValue": "{chunks} chunks / about {requests} model requests",
  "character.memory.importComplete": "Long-term memory import complete",
  "character.memory.importCompleteBody": "Extracted {extracted}, saved {saved}, and skipped {duplicates} duplicates.",
  "character.memory.importConfirm": "Confirm and extract",
  "character.memory.importDialogue": "Plain dialogue",
  "character.memory.importDialogueValue": "{lines} lines / {characters} characters",
  "character.memory.importEstimatedInput": "Estimated input tokens",
  "character.memory.importEstimatedOutput": "Estimated output tokens",
  "character.memory.importEstimatedTotal": "Estimated total tokens",
  "character.memory.importFailed": "Long-term memory import failed",
  "character.memory.importFileDetail": "{kind} · about {tokens} tokens · {chunks} chunks",
  "character.memory.importJsonNote":
    "JSON history is first converted to the same plain-dialogue format used by Copy history, then split by length for extraction.",
  "character.memory.importPickerTitle": "Select TXT / JSON history files",
  "character.memory.importPreparing": "Preparing the import task…",
  "character.memory.importPreviewSummary":
    "Selected {files} files: about {tokens} tokens across {chunks} chunks / model requests. Extraction will not start until you confirm.",
  "character.memory.importPreviewTitle": "Long-term memory import preview",
  "character.memory.importRunning": "Extracting…",
  "character.memory.importSourceTokens": "Source tokens",
  "character.memory.importTaskTitle": "Import long-term memories",
  ...
  "mediaAutoLabel.action": "Smart labeling",
  "mediaAutoLabel.complete": "Labeled {annotated}, kept {skipped} existing labels, and failed {failed}.",
  "mediaAutoLabel.error": "Smart image labeling failed.",
  "mediaAutoLabel.preparing": "Preparing the smart-labeling task…",
  "mediaAutoLabel.progressTitle": "Smart-labeling progress",
  "mediaAutoLabel.running": "Smart labeling in progress",
  ...
  "chat.actionBar.config": "APPEARANCE SETTINGS",
  "chat.actionBar.copy": "COPY",
  "chat.actionBar.branches": "TREE",
  "chat.actionBar.history": "HISTORY",
  ...
  "chat.config.dialogWidth": "Dialog width",
  "chat.config.dialogWidthCustom": "Custom dialog width",
  "chat.config.dialogWidthValue": "{value}% of screen",
  ...
  "chat.config.longPressTalk": "Enable F8 hold to talk",
  ...
  "chat.init.description":
    "Starting voice services, loading memory, and preparing the chat runtime. This may take a moment.",
  "chat.init.failed": "Chat preparation failed",
  "chat.init.inProgress": "In progress",
  "chat.init.phase.cancelled": "Chat preparation was cancelled",
  "chat.init.phase.completed": "Chat is ready",
  "chat.init.phase.failed": "Chat preparation failed",
  "chat.init.phase.finalizing": "Finishing chat preparation",
  "chat.init.phase.memory": "Loading long-term memory",
  "chat.init.phase.plugins": "Preparing chat extensions",
  "chat.init.phase.preparing": "Preparing chat",
  "chat.init.phase.runtime": "Starting chat runtime",
  "chat.init.phase.tts": "Starting voice service",
  "chat.init.title": "Preparing chat",
  "chat.init.waitingForProgress": "Waiting for the chat runtime to report progress…",
  ...
  "chat.input.batch": "Stack",
  "chat.input.batchCancel": "Discard stacked messages",
  "chat.input.batchCountdown": "{count} queued · {seconds}s",
  "chat.input.batchSendNow": "Send stacked messages now",
  "chat.input.batchWaiting": "{count} queued · typing",
  "chat.input.interrupt": "Interrupt",
  ...
  "chat.input.attachFile": "File",
  "chat.input.attachImage": "Image",
  "chat.input.attachmentLimit": "You can attach up to {count} items to one message.",
  "chat.input.attachments": "Message attachments",
  "chat.input.filePickerTitle": "Attach files",
  "chat.input.imagePickerTitle": "Attach images",
  ...
  "chat.input.settings": "Chat settings",
  "chat.input.turnControls": "Chat sending controls",
  ...
  "chat.toolbar.config": "Chat appearance settings",
  ...
  "chat.theme.customize": "Customize theme",
  "chat.theme.customizer.align": "Alignment",
  "chat.theme.customizer.back": "Back to themes",
  "chat.theme.customizer.background": "Background",
  "chat.theme.customizer.baseTheme": "Base / editable theme",
  "chat.theme.customizer.borderColor": "Border color",
  "chat.theme.customizer.borderRadius": "Corner radius (CSS)",
  "chat.theme.customizer.chrome": "Dialog chrome",
  "chat.theme.customizer.cloneHint":
    "Built-in themes stay read-only. Saving copies their SVG, font, and sound assets into a new user theme.",
  "chat.theme.customizer.customName": "{name} · Custom",
  "chat.theme.customizer.decoration": "Nameplate decoration",
  "chat.theme.customizer.description":
    "Tune the Chat UI from an existing theme and preview the real components before saving.",
  "chat.theme.customizer.editHint": "Editing a user theme. Existing files in its asset directory are preserved.",
  "chat.theme.customizer.fontFamily": "Font family",
  "chat.theme.customizer.fontSize": "Font size",
  "chat.theme.customizer.fontWeight": "Font weight",
  "chat.theme.customizer.gap": "Gap",
  "chat.theme.customizer.height": "Height",
  "chat.theme.customizer.idDuplicate": "That theme ID already exists. Choose another one.",
  "chat.theme.customizer.idError": "Use lowercase letters, numbers, - or _ only, up to 64 characters.",
  "chat.theme.customizer.layout": "Layout",
  "chat.theme.customizer.loadError": "Could not load the theme configuration.",
  "chat.theme.customizer.loading": "Loading theme configuration…",
  "chat.theme.customizer.maxWidth": "Maximum width",
  "chat.theme.customizer.nameError": "Theme name is required.",
  "chat.theme.customizer.offsetY": "Vertical offset",
  "chat.theme.customizer.overlap": "Dialog overlap",
  "chat.theme.customizer.padding": "Padding",
  "chat.theme.customizer.placement": "Placement",
  "chat.theme.customizer.preview": "Live preview",
  "chat.theme.customizer.previewDialog": "Dialog",
  "chat.theme.customizer.previewHint": "Uses the same theme resolver and components as the chat window",
  "chat.theme.customizer.previewName": "Mio Sakuraba",
  "chat.theme.customizer.previewOptionOne": "Follow the lights toward the station",
  "chat.theme.customizer.previewOptions": "Options",
  "chat.theme.customizer.previewOptionThree": "Stay here and watch for now",
  "chat.theme.customizer.previewOptionTwo": "Ask her what happened",
  "chat.theme.customizer.previewText":
    "The evening wind crosses the platform as the distant city lights flicker on. Something unusual may happen tonight.",
  "chat.theme.customizer.reset": "Discard unsaved changes",
  "chat.theme.customizer.saved": "Theme saved and applied",
  "chat.theme.customizer.saveError": "Could not save the theme configuration.",
  "chat.theme.customizer.sectionDialog": "Dialog",
  "chat.theme.customizer.sectionGlobal": "Global appearance",
  "chat.theme.customizer.sectionInput": "Input area",
  "chat.theme.customizer.sectionMetadata": "Theme details",
  "chat.theme.customizer.sectionName": "Character nameplate",
  "chat.theme.customizer.sectionOptions": "Option buttons",
  "chat.theme.customizer.sectionTypewriter": "Typewriter",
  "chat.theme.customizer.textColor": "Text color",
  "chat.theme.customizer.themeColor": "Theme color",
  "chat.theme.customizer.themeId": "Theme ID",
  "chat.theme.customizer.title": "Customize Chat UI",
  "chat.theme.customizer.typewriterSpeed": "Typing speed",
  "chat.theme.customizer.version": "Version",
  "chat.theme.customizer.width": "Width",
  "chat.theme.customizer.widthMode": "Width mode",
  ...
  "template.optionHelp": "Regenerate or save after changing rules.",
  "template.primaryCharacters.confirm": "Apply roles",
  "template.primaryCharacters.configure": "Choose primary characters",
  "template.primaryCharacters.count": "{count} primary of {total} characters",
  "template.primaryCharacters.description":
    "You selected {count} characters. Primary characters use full settings; others use briefs. Missing briefs will be generated and saved. There is no primary-character limit.",
  "template.primaryCharacters.hasBrief": "Brief ready",
  "template.primaryCharacters.modify": "Change",
  "template.primaryCharacters.needsBrief": "Brief will be generated",
  "template.primaryCharacters.primary": "Primary character",
  "template.primaryCharacters.statusCompact": "{primary} primary · {secondary} supporting",
  "template.primaryCharacters.statusFull": "{count} selected · all are primary",
  "template.primaryCharacters.statusPending": "{count} selected · roles need to be set",
  "template.primaryCharacters.title": "Choose primary characters",
  "template.primaryCharacters.useAll": "Use all as primary",
  ...
  "template.section.options": "Prompt options",
  "template.section.scenario": "User scenario",
  "template.section.system": "System template",
  "template.semanticMedia.error": "Could not initialize smart sprite matching.",
  "template.semanticMedia.hint":
    "Match sprites, scenes, and BGM from vibe using the vector database without putting asset ids in the system prompt.",
  "template.semanticMedia.label": "Smart sprite matching",
  "template.semanticMedia.preparing": "Preparing smart sprite matching…",
  ...
  "effect.action.saveImageTags": "Save image prompts",
  "effect.action.uploadContribution": "Upload Effect",
  "effect.asset.addAudio": "New Audio",
  "effect.asset.batchInsertAudio": "Insert audio in batch",
  "effect.asset.batchInsertAudioComplete": "Audio attached to {count} images",
  ...
  "effect.section.image": "Image effects",
