...
export const enMessages: Record<MessageKey, string> = {
  ...
  "mediaAutoLabel.action": "Label untagged with Moondream",
  "mediaAutoLabel.complete": "Labeled {annotated}, kept {skipped} existing labels, and failed {failed}.",
  "mediaAutoLabel.error": "Moondream image labeling failed.",
  "mediaAutoLabel.preparing": "Preparing the image-labeling task…",
  "mediaAutoLabel.progressTitle": "Moondream labeling progress",
  "mediaAutoLabel.running": "Labeling in progress",
