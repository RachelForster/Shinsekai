...
export const zhCNMessages: Record<MessageKey, string> = {
  ...
  "desktop.runtime.phase.probing": "正在扫描托管运行环境",
  ...
  "system.runtime.description": "查看 Shinsekai 托管运行环境，或修复其依赖。",
  "system.runtime.installLocalAi": "安装本地 AI 运行环境",
  "system.runtime.installMedia": "安装媒体运行环境",
  "system.runtime.noCandidates": "尚未扫描到托管运行环境候选。",
  "system.runtime.optionalDescription": "进入程序后可在这里补装媒体处理和本地 AI 依赖。",
  "system.runtime.optionalTitle": "可选运行环境",
  "system.runtime.scan": "扫描托管运行环境",
