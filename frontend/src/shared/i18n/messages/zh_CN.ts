...
export const zhCNMessages: Record<MessageKey, string> = {
  ...
  "player.select": "主控人物（你扮演的角色）",
  "player.configure": "主控人物",
  "player.none": "不设置主控人物",
  "player.hint": "主控台词和主动行动由你输入；AI 可以描写互动，并调整头像表情。",
  "player.readSpeech": "朗读主控台词",
  "player.speechHint": "使用主控角色的语音配置；括号动作、【心理活动】及“心理活动：”行不朗读。",
  "player.adjust": "调整主控头像",
  "player.reset": "重置裁剪",
  "player.sprite": "选择表情立绘",
  "player.dragHint": "拖动图片对准头部，也可以使用下方滑杆调整。切换立绘前请先保存当前调整。",
  "player.x": "水平位置",
  "player.y": "垂直位置",
  "player.zoom": "缩放",
  "player.individual": "只应用于当前立绘（关闭则保存为角色默认）",
  ...
  "reminder.status.active": "待提醒",
  "reminder.futureTime": "请选择未来的提醒时间。",
  "reminder.recurrence": "重复频率",
  "reminder.fieldTime": "下次提醒时间（本机时间）",
  "reminder.fieldMessage": "提醒内容",
  "reminder.fieldTitle": "日程标题",
  "reminder.character": "提醒人物",
  "reminder.randomHint": "随机角色会在每次到期时从已有角色中选择，并按角色性格生成台词和语音。",
  "reminder.random": "随机角色",
  "reminder.edit": "编辑日程",
  "reminder.delete": "删除日程",
  "desktop.background.autostartHint": "开关立即生效，登录系统后启动 Shinsekai 并恢复日程检查。",
  "desktop.background.autostart": "登录系统时自动启动",
  ...
  "desktop.background.retry": "重新加载",
  "desktop.windowClose.title": "要关闭 Shinsekai 吗？",
  "desktop.windowClose.body": "最小化到托盘后，角色仍可按日程提醒你。退出程序会停止聊天和所有提醒。",
  "desktop.windowClose.exit": "退出程序",
  "desktop.windowClose.tray": "最小化到托盘",
  "desktop.windowClose.cancel": "取消",
  "desktop.windowClose.remember": "记住我的选择",
  "desktop.windowClose.hint": "可在「系统设置 → 托盘与日程」中修改关闭行为。",
  "desktop.windowClose.unavailable": "系统托盘暂不可用，可以取消或退出程序。",
  "desktop.windowClose.behavior": "关闭主窗口时",
  "desktop.windowClose.ask": "每次询问",
  "reminder.playVoice": "播放角色语音",
  "reminder.muteVoice": "静音提醒",
  "reminder.unmuteVoice": "开启提醒语音",
  "reminder.manage": "管理提醒",
  "reminder.back": "返回小卡片",
  "reminder.previous": "上一条提醒",
  "reminder.next": "下一条提醒",
  "reminder.title": "角色提醒",
  "reminder.upcoming": "全部日程",
  "reminder.inbox": "收到的提醒",
  "reminder.empty": "暂时没有日程",
  "reminder.hello": "把要记住的事，交给我吧。",
  "reminder.hint": "在聊天中说“十分钟后提醒我休息”，角色就能为你安排。",
  "reminder.close": "收起",
  "reminder.main": "打开主程序",
  "reminder.cancel": "取消日程",
  "reminder.done": "知道啦",
  "reminder.crop": "头像裁切",
  "reminder.top": "显示立绘上部",
  "reminder.once": "一次",
  ...
  "story.editor.brief": "原始创作要求（作者用）",
  "story.editor.node": "节点内容",
  "story.editor.nodeTitle": "节点标题",
  "story.editor.storyTitle": "剧本名称",
  "story.editor.type": "节点类型",
  "story.editor.instruction": "剧情正文 / 演绎要求",
  "story.editor.instructionHint": "写清此处发生什么、人物应如何反应，以及本节点可以揭示的信息。游玩时 LLM 会据此演绎。",
  "story.editor.background": "场景提示（选填）",
  "story.editor.rounds": "最多对话轮数",
  "story.editor.transitions": "剧情连线",
  "story.editor.target": "目标节点",
  "story.editor.chooseTarget": "选择目标节点",
  "story.editor.condition": "跳转条件",
  "story.editor.removeEdge": "删除连线",
  "story.editor.addEdge": "添加连线",
  "story.editor.defaultTarget": "轮数耗尽时的默认去向",
  "story.editor.none": "无",
  "story.editor.start": "起始节点",
  "story.editor.newNode": "新节点",
  "story.editor.addNode": "新增节点",
  "story.editor.deleteNode": "删除当前节点及关联连线",
  "story.editor.undo": "撤销上一步",
  "story.editor.ai": "LLM 辅助修改",
  "story.editor.aiHint":
    "单节点修改只替换选中的节点；修改整张图可新增、删除节点并调整分支。结果先预览，采纳后才进入草稿。",
  "story.editor.scope": "修改范围",
  "story.editor.scopeNode": "当前节点：{title}",
  "story.editor.scopeGraph": "整个节点图（可生成新节点）",
  "story.editor.request": "修改要求",
  "story.editor.requestPlaceholder": "例如：在调查与结局之间加入一段对质，并增加一个和解分支。",
  "story.editor.suggest": "生成候选修改",
  "story.editor.working": "正在处理，请稍候…",
  "story.editor.proposal": "候选修改预览",
  "story.editor.added": "新增",
  "story.editor.removed": "删除",
  "story.editor.changed": "修改",
  "story.editor.before": "修改前",
  "story.editor.after": "修改后",
  "story.editor.accept": "采纳到草稿",
  "story.editor.discard": "放弃候选",
  "story.editor.save": "校验并保存新版本",
  "story.editor.saved": "新版本已保存，可在已有剧本中找到。",
  "story.editor.play": "用新版本开始游玩",
  "story.editor.settings": "剧本设置",
  "story.editor.settingsHint": "当前聊天保持原剧本与进度。编辑器可查看完整剧情并另存新版本。",
  "story.editor.openFromSettings": "打开剧本编辑器（含后续剧情）",
  ...
  "story.setup.synopsisOptional": "创作要求（选填）",
  "story.setup.synopsis": "创作要求",
  "story.setup.synopsisPlaceholder":
    "写下题材、冲突、风格或结局方向，也可以让 AI 根据人物和背景创作。这些要求用于编剧，不会直接作为游玩时的开场提示词。",
  ...
  "api.vision.apiKey": "服务商 API Key",
  "api.vision.auto": "自动选择",
  "api.vision.baseUrl": "服务商基础 URL",
  "api.vision.checkingModel": "正在检查 Moondream 模型…",
  "api.vision.description":
    "为不支持原生图片输入的语言模型选择图片理解服务；自动模式会优先使用插件，再尝试本地 Moondream。",
  "api.vision.downloadModel": "下载模型",
  "api.vision.downloadingModel": "正在下载 Moondream 模型…",
  "api.vision.fetchDone": "已获取 {count} 个视觉模型。",
  "api.vision.fetchEmpty": "没有获取到可用的视觉模型。",
  "api.vision.fetchFailed": "获取视觉模型列表失败。",
  "api.vision.fetchMissing": "请先填写视觉服务基础 URL；远程服务还需 API Key。",
  "api.vision.fetchModels": "获取可用模型",
  "api.vision.fetchTitle": "视觉模型列表",
  "api.vision.fetching": "正在获取模型",
  "api.vision.invalidBaseUrl": "视觉服务基础 URL 不能包含引号。",
  "api.vision.model": "视觉模型 ID",
  "api.vision.modelCached": "Moondream 模型已就绪",
  "api.vision.modelDownloadFailed": "Moondream 模型下载失败。",
  "api.vision.modelMissing": "Moondream 模型尚未下载",
  "api.vision.modelPlaceholder": "如 deepseek-flash",
  "api.vision.modelStatus": "本地模型状态",
  "api.vision.provider": "视觉适配器",
  "api.vision.required": "视觉适配器的基础 URL 和模型 ID 都需要填写；远程服务还需 API Key。",
  "api.vision.sharedCredentialsHelp": "与 LLM 配置中的 {provider} 共用服务商连接信息，修改任一处都会同步。",
  "api.vision.title": "视觉理解",
  ...
  "mediaAutoLabel.action": "智能标注",
  "mediaAutoLabel.complete": "已标注 {annotated} 张，保留已有标签 {skipped} 张，失败 {failed} 张。",
  "mediaAutoLabel.error": "图片智能标注失败。",
  "mediaAutoLabel.preparing": "正在创建智能标注任务…",
  "mediaAutoLabel.progressTitle": "智能标注进度",
  "mediaAutoLabel.running": "智能标注进行中",
  ...
  "effect.action.saveImageTags": "保存图片提示词",
  "effect.action.uploadContribution": "上传特效",
  "effect.asset.addAudio": "新建音频",
  "effect.asset.batchInsertAudio": "批量插入音频",
  "effect.asset.batchInsertAudioComplete": "已为 {count} 张图片绑定音频",
