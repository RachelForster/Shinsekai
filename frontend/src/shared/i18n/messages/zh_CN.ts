...
export const zhCNMessages: Record<MessageKey, string> = {
  ...
  "template.semanticMedia.error": "智能氛围匹配初始化失败。",
  "template.semanticMedia.hint": "用 vibe 在向量数据库中匹配立绘、场景和 BGM，不把资源编号写入系统提示词。",
  "template.semanticMedia.label": "智能氛围匹配",
  "template.semanticMedia.preparing": "正在准备智能匹配…",
  "template.title": "聊天模板",
