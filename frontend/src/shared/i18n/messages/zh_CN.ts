...
export const zhCNMessages: Record<MessageKey, string> = {
  ...
  "character.sprite.voiceTypeReference": "参考语音（需通过系统检测）",
  ...
  "template.ruleChangeDialog.body": "检测到用户对内容规则进行调整，是否要快速重启",
  "template.ruleChangeDialog.title": "内容规则变更",
  "template.ruleChangeDialog.toast": "聊天将沿用之前存档规则",
