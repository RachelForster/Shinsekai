...
export const zhCNMessages: Record<MessageKey, string> = {
  "desktop.background.panel": "打开提醒面板",
  "desktop.background.title": "托盘与睡觉提醒",
  ...
  "desktop.background.enabled": "每天提醒我睡觉",
  "desktop.background.time": "提醒时间（本机时间）",
  "desktop.background.reminderHint":
    "每次随机选择已有角色，由 LLM 根据性格生成台词，并用已配置的 TTS 合成语音；生成失败时保留本地文案。",
  ...
  "desktop.background.test": "测试通知",
  "desktop.background.tested": "已打开角色提醒面板；测试不影响每日提醒。",
  "desktop.background.invalidTime": "请输入有效时间（00:00–23:59）。",
  ...
  "desktop.windowClose.hint": "可在「系统设置 → 托盘与睡觉提醒」中修改关闭行为。",
