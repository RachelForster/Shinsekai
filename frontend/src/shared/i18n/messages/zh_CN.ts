...
export const zhCNMessages: Record<MessageKey, string> = {
  ...
  "chat.config.appearanceGlobal": "全局默认",
  "chat.config.appearanceHelp": "越靠后的层级优先级越高；会话值保持默认时，会继续继承当前主题。",
  "chat.config.appearancePrecedence": "外观覆盖优先级",
  "chat.config.appearanceSaveError": "无法把当前外观保存为主题。",
  "chat.config.appearanceSaved": "已保存并启用为 {id}。",
  "chat.config.appearanceSession": "当前会话",
  "chat.config.appearanceTheme": "当前主题",
  ...
  "chat.theme.customizer.diagnostic.contrast": "{section}：文字对比度仅 {detail}（目标 4.5:1）。",
  "chat.theme.customizer.diagnostic.missing-asset": "引用的资源不存在：{detail}。",
  "chat.theme.customizer.diagnostic.viewport-overflow": "{section}：在{detail}视口中可能溢出。",
  "chat.theme.customizer.diagnosticsReady": "未发现明显的主题问题",
  "chat.theme.customizer.diagnosticsWarning": "主题诊断发现需要处理的问题",
  "chat.theme.customizer.previewDialog": "对话",
  "chat.theme.customizer.previewHint": "使用与聊天窗口相同的主题解析器和组件",
  "chat.theme.customizer.previewLogLine1": "主题清单已加载并通过校验。",
  "chat.theme.customizer.previewLogLine2": "流式响应在 842 毫秒内完成。",
  "chat.theme.customizer.previewLogLine3": "本轮将使用音频回退方案。",
  "chat.theme.customizer.previewLogs": "日志",
  "chat.theme.customizer.previewLogsSearch": "搜索事件、级别或来源",
  ...
  "chat.theme.customizer.previewState": "交互状态",
  "chat.theme.customizer.previewToolbar": "工具栏",
  ...
  "chat.theme.customizer.previewViewport": "预览视口",
  ...
  "chat.theme.customizer.addFont": "添加字体",
  "chat.theme.customizer.assetDeleted": "主题资源已删除",
  "chat.theme.customizer.assetDeleteError": "无法删除主题资源。",
  "chat.theme.customizer.assetListError": "无法读取主题资源列表。",
  "chat.theme.customizer.assetPlaceholder": "主题目录内的相对资源路径",
  "chat.theme.customizer.assetSaveFirst": "请先保存为用户主题，再上传或管理资源。",
  "chat.theme.customizer.assetsEmpty": "尚未上传自定义资源。",
  "chat.theme.customizer.assetsLoading": "正在读取主题资源…",
  "chat.theme.customizer.assetUpload": "上传资源",
  "chat.theme.customizer.assetUploadError": "无法上传主题资源。",
  "chat.theme.customizer.assetUploaded": "主题资源已上传",
  "chat.theme.customizer.backgroundImage": "背景图片",
  "chat.theme.customizer.boxShadow": "阴影（CSS 值）",
  "chat.theme.customizer.editorMode": "编辑器模式",
  "chat.theme.customizer.fieldBackground": "输入内层背景",
  "chat.theme.customizer.fieldRadius": "输入内层圆角",
  "chat.theme.customizer.fontSizeResponsive": "响应式字号",
  "chat.theme.customizer.fontSource": "字体资源路径",
  "chat.theme.customizer.frameImage": "九宫格边框资源",
  "chat.theme.customizer.frameOutset": "边框外扩",
  "chat.theme.customizer.frameSlice": "九宫格切片",
  "chat.theme.customizer.frameWidth": "边框显示宽度",
  "chat.theme.customizer.hideAtStart": "起始选项出现时隐藏",
  "chat.theme.customizer.icon": "图标",
  "chat.theme.customizer.inherit": "继承主题",
  "chat.theme.customizer.inherited": "继承",
  "chat.theme.customizer.level.debug": "调试",
  "chat.theme.customizer.level.default": "默认",
  "chat.theme.customizer.level.error": "错误",
  "chat.theme.customizer.level.info": "信息",
  "chat.theme.customizer.level.warn": "警告",
  "chat.theme.customizer.logsBadge": "徽章",
  "chat.theme.customizer.logsCode": "代码区",
  "chat.theme.customizer.logsDetail": "详情区",
  "chat.theme.customizer.logsEvent": "事件徽章",
  "chat.theme.customizer.logsFile": "文件列表项",
  "chat.theme.customizer.logsLevels": "日志级别",
  "chat.theme.customizer.logsLine": "日志行",
  "chat.theme.customizer.logsNumber": "行号",
  "chat.theme.customizer.logsPage": "日志页面",
  "chat.theme.customizer.logsPanel": "日志面板",
  "chat.theme.customizer.logsSidebar": "日志侧栏",
  "chat.theme.customizer.logsSource": "来源标签",
  "chat.theme.customizer.logsToolbar": "日志工具栏",
  "chat.theme.customizer.logsViewer": "日志查看器",
  "chat.theme.customizer.minHeight": "最小高度",
  "chat.theme.customizer.minHeightResponsive": "响应式最小高度",
  "chat.theme.customizer.minWidth": "最小宽度",
  "chat.theme.customizer.modeAdvanced": "高级",
  "chat.theme.customizer.modeAdvancedHint": "编辑全部主题令牌、状态、资源和日志外观。",
  "chat.theme.customizer.modeBasic": "基础",
  "chat.theme.customizer.modeBasicHint": "只显示最常用的颜色、排版和布局选项。",
  "chat.theme.customizer.nameClearance": "名牌安全距离",
  "chat.theme.customizer.nameInputGap": "名牌到输入区距离",
  "chat.theme.customizer.resetSection": "重置本区",
  "chat.theme.customizer.reveal": "显示方式",
  "chat.theme.customizer.sectionFonts": "自定义字体",
  "chat.theme.customizer.sectionLogs": "日志页面",
  "chat.theme.customizer.sectionSend": "发送按钮",
  "chat.theme.customizer.sectionAssets": "主题资源工作台",
  "chat.theme.customizer.sectionToolbar": "工具栏",
  "chat.theme.customizer.sendPlacement": "发送按钮位置",
  "chat.theme.customizer.stateActive": "激活状态",
  "chat.theme.customizer.stateDefault": "默认状态",
  "chat.theme.customizer.stateExpanded": "展开状态",
  "chat.theme.customizer.stateHover": "悬停状态",
  "chat.theme.customizer.viewportCompact": "紧凑",
  "chat.theme.customizer.viewportDesktop": "桌面",
  "chat.theme.customizer.viewportMobile": "移动端",
  "chat.theme.customizer.textShadow": "文字阴影",
  "chat.theme.customizer.typewriterSound": "打字音效",
  "common.redo": "重做",
  "common.undo": "撤销",
  "chat.theme.error.export": "无法导出主题。",
  "chat.theme.export": "导出主题",
  "chat.theme.exported": "主题已导出",
