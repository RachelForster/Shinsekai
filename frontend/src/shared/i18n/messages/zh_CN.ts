...
export const zhCNMessages: Record<MessageKey, string> = {
  ...
  "mention.empty": "没有匹配的角色",
  "mention.listLabel": "角色提及",
  "mention.user": "用户",
  ...
  "template.validation.storyRequired": "请先选择一个已有剧本。",
  "template.field.playMode": "游玩模式",
  "template.playMode.free": "自由模式",
  "template.playMode.freeHint": "自由模式沿用当前开放式聊天模板。",
  "template.playMode.openCreator": "进入剧本创作",
  "template.playMode.openEditor": "打开所选剧本",
  "template.playMode.noStories": "还没有已保存的剧本，请先去创作一页。",
  "template.playMode.selectStory": "已有剧本",
  "template.playMode.selectStoryPlaceholder": "选择已有剧本",
  "template.playMode.story": "剧本创作",
  "template.playMode.storyCast": "剧本人设",
  "template.playMode.graphTitle": "剧本图",
  "template.playMode.graphLoading": "正在加载剧本图…",
  "template.playMode.storyHint": "选择已有剧本后开始聊天，或进入创作页生成新剧本。人物与情景由剧本自己决定。",
  "story.editor.addChoice": "+ 添加选择",
  "story.editor.addCharacter": "+ 人物",
  "story.editor.addEffect": "添加增量",
  "story.editor.addNode": "+ 节点",
  "story.editor.addRule": "+ 规则节点",
  "story.editor.addSignal": "+ 信号",
  "story.editor.addVariable": "+ 变量",
  "story.editor.aiApply": "应用此补丁",
  "story.editor.aiGenerate": "生成补丁",
  "story.editor.aiInstruction": "AI 修改说明",
  "story.editor.aiPlaceholder": "例如：强化这一场景的抉择，但保持现有节点 ID 和所有已承诺事实。",
  "story.editor.aiProposal": "候选补丁：{count} 项差异，{status}",
  "story.editor.aiTitle": "AI 局部重生与差异",
  "story.editor.backToGenerator": "← 剧本生成器",
  "story.editor.castEmpty": "无人",
  "story.editor.castMode": "模式",
  "story.editor.castMode.dynamic": "动态候选",
  "story.editor.castMode.fixed": "固定",
  "story.editor.castMode.mixed": "混合",
  "story.editor.castMode.roleBased": "职责驱动",
  "story.editor.castPreview": "预览演员表",
  "story.editor.castRequired": "固定角色（以逗号分隔）",
  "story.editor.castSelected": "已选：{ids}",
  "story.editor.castTitle": "演员表与 CastPolicy",
  "story.editor.choiceGoto": "选项 {index} 目标",
  "story.editor.choiceLabel": "选项 {index} 文案",
  "story.editor.choiceTarget": "选择目标节点",
  "story.editor.choices": "结构化选项",
  "story.editor.confidence.high": "高",
  "story.editor.confidence.low": "低",
  "story.editor.confidence.medium": "中",
  "story.editor.commitment": "承诺边界",
  "story.editor.commitment.committed": "已承诺",
  "story.editor.commitment.draft": "草稿",
  ...
  "story.editor.effectAmount": "效果增量",
  "story.editor.effectCount": "当前效果：{count} 条",
  "story.editor.enterCondition": "进入条件",
  "story.editor.enterEffects": "进入效果",
  "story.editor.enterWhen": "变量阈值（留空表示总是可进入）",
  "story.editor.enterWhenPlaceholder": "例如 trust.ling >= 10",
  "story.editor.endings": "结局试演",
  "story.editor.eyebrow": "STORY CREATOR",
  "story.editor.finalNode": "最终节点：{id}",
  "story.editor.graphEdges": "图关系",
  "story.editor.graphTitle": "图与端口诊断",
  "story.editor.loading": "加载剧本…",
  "story.editor.maxActive": "最大活跃人数",
  "story.editor.missingId": "缺少剧本 ID。",
  "story.editor.newChoice": "选择 {index}",
  "story.editor.newScene": "新场景 {index}",
  "story.editor.nodeTitle": "标题",
  "story.editor.nodeType": "节点类型",
  "story.editor.nodeType.ending": "结局",
  "story.editor.nodeType.story": "剧情场景",
  "story.editor.nodes": "剧情节点",
  ...
  "story.editor.ruleType": "规则 {index} 类型",
  "story.editor.rules": "逻辑图节点",
  "story.editor.selectNode": "选择一个节点开始编辑。",
  "story.editor.selectedNode": "场景与节点",
  "story.editor.signalId": "信号 {index} ID",
  "story.editor.signals": "语义信号",
  "story.editor.sourceMap": "源码映射",
  "story.editor.step": "步骤 {step} · {action}",
  "story.editor.undo": "撤销",
  "story.editor.validate": "发布前校验",
  "story.editor.variableId": "变量 ID",
  "story.editor.variableType.boolean": "布尔",
  "story.editor.variableType.enum": "枚举",
  "story.editor.variableType.integer": "整数",
  "story.editor.variableType.stringSet": "字符串集合",
  "story.editor.variables": "变量",
  "story.editor.variablesTitle": "变量、语义信号与规则",
  "story.editor.validationFailed": "仍有校验问题",
  "story.editor.validationPassed": "已通过校验",
  "story.generator.assumptions": "生成假设",
  "story.generator.assumptionsEmpty": "需求阶段完成后显示。",
  "story.generator.cancel": "取消",
  "story.generator.castFailures": "演员表失败",
  "story.generator.description": "LLM 负责分阶段创作；Schema、引用、路径、演员表与秘密隔离由确定性编译器裁决。",
  "story.generator.endingCoverage": "结局覆盖",
  "story.generator.estimatedTokens": "估算 Tokens",
  ...
  "story.generator.progressMeta": "状态：{status} · 当前阶段：{stage}",
  "story.generator.regenerate": "重新生成",
  "story.generator.regenerateHint": "所选阶段之后的产物会失效，之前的稳定产物保留。",
  "story.generator.regenerateStage": "重新生成阶段",
  "story.generator.regenerateTitle": "局部重新生成",
  "story.generator.resume": "从断点继续",
  "story.generator.stage.bible": "故事圣经",
  "story.generator.stage.characters": "人物职责",
  "story.generator.stage.logic": "逻辑图",
  "story.generator.stage.narrative": "剧情图",
  "story.generator.stage.requirements": "需求与假设",
  "story.generator.stage.resources": "资源绑定",
  "story.generator.stage.state": "状态与信号",
  "story.generator.start": "开始生成",
  "story.generator.synopsis": "剧情梗概",
  "story.generator.title": "从剧情梗概生成可运行剧本",
  "story.generator.validation": "校验摘要",
