...
export const zhCNMessages: Record<MessageKey, string> = {
  ...
  "api.vision.apiKey": "视觉 API Key",
  "api.vision.auto": "自动选择",
  "api.vision.baseUrl": "视觉服务基础 URL",
  ...
  "api.vision.reuseLlmApiKey": "复用 LLM API Key",
  "api.vision.reuseLlmApiKeyHelp": "使用 {provider} 配置中保存的 API Key，不再单独保存一份。",
