...
export type MessageKey =
  ...
  | "aiSprites.generateAllImages"
  | "aiSprites.generateImage"
  | "aiSprites.generatePrompts"
  | "aiSprites.generateSelected"
  | "aiSprites.imageFailed"
  | "aiSprites.imageGenerated"
  | "aiSprites.imageTitle"
  | "aiSprites.llm"
  | "aiSprites.loading"
  | "aiSprites.negativePrompt"
  | "aiSprites.notReadyBody"
  | "aiSprites.notReadyTitle"
  | "aiSprites.promptDrafts"
  | "aiSprites.promptDraftsHint"
  | "aiSprites.promptCandidate"
  | "aiSprites.promptEmptyBody"
  ...
  | "aiSprites.tag.angry"
  | "aiSprites.tag.happy"
  | "aiSprites.tag.normal"
  | "aiSprites.tag.sad"
  | "aiSprites.composition"
  | "aiSprites.composition.fullBody"
  | "aiSprites.composition.thighUp"
  | "aiSprites.composition.upperBody"
  | "aiSprites.spriteCount"
  | "aiSprites.spriteTag"
  | "aiSprites.title"
  | "api.resume.btn"
  | "api.resume.tip"
  ...
  | "character.aiSprites.cardAction"
  | "character.aiSprites.cardBody"
  | "character.aiSprites.cardEyebrow"
  | "character.aiSprites.cardTitle"
