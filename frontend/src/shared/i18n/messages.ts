...
export type MessageKey =
  ...
  | "story.editor.brief"
  | "story.editor.node"
  | "story.editor.nodeTitle"
  | "story.editor.storyTitle"
  | "story.editor.type"
  | "story.editor.instruction"
  | "story.editor.instructionHint"
  | "story.editor.background"
  | "story.editor.rounds"
  | "story.editor.transitions"
  | "story.editor.target"
  | "story.editor.chooseTarget"
  | "story.editor.condition"
  | "story.editor.removeEdge"
  | "story.editor.addEdge"
  | "story.editor.defaultTarget"
  | "story.editor.none"
  | "story.editor.start"
  | "story.editor.newNode"
  | "story.editor.addNode"
  | "story.editor.deleteNode"
  | "story.editor.undo"
  | "story.editor.ai"
  | "story.editor.aiHint"
  | "story.editor.scope"
  | "story.editor.scopeNode"
  | "story.editor.scopeGraph"
  | "story.editor.request"
  | "story.editor.requestPlaceholder"
  | "story.editor.suggest"
  | "story.editor.working"
  | "story.editor.proposal"
  | "story.editor.added"
  | "story.editor.removed"
  | "story.editor.changed"
  | "story.editor.before"
  | "story.editor.after"
  | "story.editor.accept"
  | "story.editor.discard"
  | "story.editor.save"
  | "story.editor.saved"
  | "story.editor.play"
  | "story.editor.settings"
  | "story.editor.settingsHint"
  | "story.editor.openFromSettings"
  ...
  | "conversation.rename"
  | "conversation.title"
  | "conversation.optionalTitle"
  | "conversation.titlePlaceholder"
  | "conversation.emptyGreeting"
  | "conversation.normal"
  | "conversation.story"
  ...
  | "desktop.background.autostart"
  | "desktop.background.panel"
  | "desktop.background.title"
  | "desktop.background.minimize"
  | "desktop.background.unavailable"
  | "desktop.background.save"
  | "desktop.background.saved"
  | "desktop.background.loading"
  | "desktop.background.retry"
  | "desktop.windowClose.title"
  | "desktop.windowClose.body"
  | "desktop.windowClose.exit"
  | "desktop.windowClose.tray"
  | "desktop.windowClose.cancel"
  | "desktop.windowClose.remember"
  | "desktop.windowClose.hint"
  | "desktop.windowClose.unavailable"
  | "desktop.windowClose.behavior"
  | "desktop.windowClose.ask"
  | "reminder.playVoice"
  | "reminder.muteVoice"
  | "reminder.unmuteVoice"
  | "reminder.manage"
  | "reminder.back"
  | "reminder.previous"
  | "reminder.next"
  ...
  | "story.generated"
  | "story.savedHint"
  | "story.regenerate.title"
  | "story.regenerate.hint"
  | "story.regenerate.stage"
  | "story.regenerate.action"
  | "story.title"
  | "story.description"
  | "story.setup.title"
  | "story.setup.loadingCharacters"
  | "story.setup.noCharacters"
  | "story.setup.background"
  | "story.setup.synopsisOptional"
  | "story.setup.synopsis"
  | "story.setup.synopsisPlaceholder"
  | "story.setup.generating"
  | "story.setup.start"
  | "story.setup.savedHint"
  | "story.launch.action"
  | "story.launch.busy"
  | "story.launch.changed"
  | "story.launch.starting"
  | "story.enable.loadFirst"
  | "story.enable.action"
  | "story.enable.hint"
  | "story.enable.loading"
  | "story.enable.pending"
  | "story.library.loading"
  | "story.library.empty"
  | "story.library.characters"
  | "story.library.background"
  | "story.library.progress"
  | "story.library.saved"
  | "story.library.unplayed"
  | "story.library.continue"
  | "story.library.start"
  | "story.validation.title"
  | "story.validation.passed"
  | "story.validation.stopped"
  | "story.validation.repairing"
  | "story.validation.metrics"
  | "story.validation.hint"
  | "story.artifact.assumptions"
  | "story.artifact.title"
  | "story.artifact.premise"
  | "story.artifact.themes"
  | "story.artifact.worldRules"
  | "story.artifact.immutableFacts"
  | "story.artifact.secrets"
  | "story.artifact.characters"
  | "story.artifact.name"
  | "story.artifact.responsibility"
  | "story.artifact.personality"
  | "story.artifact.description"
  | "story.artifact.setting"
  | "story.artifact.summary"
  | "story.progress.title"
  | "story.progress.repairing"
  | "story.recovery.resuming"
  | "story.recovery.working"
  | "story.recovery.correcting"
  | "story.recovery.waiting"
  | "story.recovery.hint"
  | "story.recovery.attempts"
  | "story.recovery.nextRetry"
  | "story.recovery.error"
  | "story.stage.completed"
  | "story.stage.processing"
  | "story.stage.waiting"
  | "story.stage.nodes"
  | "story.stage.details"
  | "story.stage.loading"
  | "story.stage.pending"
  | "story.stage.foundation"
  | "story.stage.foundationHint"
  | "story.stage.characters"
  | "story.stage.charactersHint"
  | "story.stage.narrative"
  | "story.stage.narrativeHint"
  | "story.status.queued"
  | "story.status.running"
  | "story.status.succeeded"
  | "story.status.failed"
  ...
  | "story.graph.zoom"
  | "story.graph.zoomOut"
  | "story.graph.zoomReset"
  | "story.graph.zoomIn"
  | "story.graph.region"
  | "story.graph.start"
  | "story.graph.details"
  | "story.graph.endHint"
  | "story.graph.location"
  | "story.graph.rounds"
  | "story.graph.default"
  | "template.workspace.normal"
  | "template.workspace.story"
  | "template.workspace.label"
  | "app.brandSubtitle"
  | "app.preview"
  | "app.shellMeta"
  | "app.title"
  | "releaseHighlights.dismiss"
  | "releaseHighlights.explore"
  | "releaseHighlights.title"
  | "releaseHighlights.version"
  | "app.projectRoot.body"
  | "app.projectRoot.blocked"
  | "app.projectRoot.choose"
  | "app.projectRoot.current"
  | "app.projectRoot.dataDetected"
  | "app.projectRoot.error"
  | "app.projectRoot.exit"
  | "app.projectRoot.notice"
  | "app.projectRoot.reconnectNotice"
  | "app.projectRoot.rescan"
  | "app.projectRoot.rescanning"
  | "app.projectRoot.restarting"
  | "app.projectRoot.retry"
  | "app.projectRoot.select"
  | "app.projectRoot.statusError"
  | "app.projectRoot.title"
  | "app.projectRoot.unavailable"
  | "api.description"
  ...
  | "api.vision.auto"
  | "api.vision.baseUrl"
  | "api.vision.checkingModel"
  | "api.vision.description"
  | "api.vision.fetchDone"
  | "api.vision.fetchEmpty"
  | "api.vision.fetchFailed"
  | "api.vision.fetchMissing"
  | "api.vision.fetchModels"
  | "api.vision.fetchTitle"
  | "api.vision.fetching"
  | "api.vision.invalidBaseUrl"
  | "api.vision.downloadModel"
  | "api.vision.downloadingModel"
  | "api.vision.model"
  | "api.vision.modelCached"
  | "api.vision.modelDownloadFailed"
  | "api.vision.modelMissing"
  | "api.vision.modelPlaceholder"
  | "api.vision.modelStatus"
  | "api.vision.provider"
  | "api.vision.required"
  | "api.vision.reuseLlmApiKey"
  | "api.vision.reuseLlmApiKeyHelp"
  | "api.vision.title"
  | "api.loading"
  | "api.memory.checkModel"
  | "api.memory.checking"
  ...
  | "api.memory.installDependency"
  | "api.memory.installingDependency"
  | "api.memory.loadingCached"
  | "api.memory.missingDependency"
  | "api.memory.modelDownloadConfirmBody"
  | "api.memory.modelDownloadConfirmTitle"
  | "api.memory.modelDownloadFailed"
  | "api.memory.modelCached"
  | "api.memory.modelMissing"
  | "api.memory.modelMissingKeepOff"
  | "api.memory.modelStatus"
  | "api.memory.ready"
  | "api.memory.readyCached"
  | "api.memory.recheckModel"
  | "api.memory.recentBuffer"
  | "api.memory.recentBufferHelp"
  | "api.memory.searchLimit"
  | "api.memory.searchLimitHelp"
  | "api.memory.setupModelMissing"
  | "api.memory.setupReady"
  | "api.memory.statusUnknown"
  | "api.memory.taskInProgress"
  | "api.memory.taskVerifying"
  | "api.memory.title"
  | "api.resume.btn"
  | "api.resume.tip"
  | "api.resume.title"
  ...
  | "desktop.runtime.commandCopied"
  | "desktop.runtime.copyCommand"
  | "desktop.runtime.manualInstallHint"
  | "desktop.runtime.manualInstallTitle"
  ...
  | "character.memory.import"
  | "character.memory.importBillingNote"
  | "character.memory.importChunks"
  | "character.memory.importChunksValue"
  | "character.memory.importComplete"
  | "character.memory.importCompleteBody"
  | "character.memory.importConfirm"
  | "character.memory.importDialogue"
  | "character.memory.importDialogueValue"
  | "character.memory.importEstimatedInput"
  | "character.memory.importEstimatedOutput"
  | "character.memory.importEstimatedTotal"
  | "character.memory.importFailed"
  | "character.memory.importFileDetail"
  | "character.memory.importJsonNote"
  | "character.memory.importPickerTitle"
  | "character.memory.importPreparing"
  | "character.memory.importPreviewSummary"
  | "character.memory.importPreviewTitle"
  | "character.memory.importRunning"
  | "character.memory.importSourceTokens"
  | "character.memory.importTaskTitle"
  ...
  | "mediaAutoLabel.action"
  | "mediaAutoLabel.complete"
  | "mediaAutoLabel.error"
  | "mediaAutoLabel.preparing"
  | "mediaAutoLabel.progressTitle"
  | "mediaAutoLabel.running"
  | "character.title"
  ...
  | "character.validation.briefSourceRequired"
  ...
  | "chat.config.dialogWidth"
  | "chat.config.dialogWidthCustom"
  | "chat.config.dialogWidthValue"
  ...
  | "chat.config.autoHideInput"
  | "chat.config.autoHideTopTools"
  ...
  | "chat.init.failed"
  | "chat.init.inProgress"
  | "chat.init.phase.cancelled"
  | "chat.init.phase.completed"
  | "chat.init.phase.failed"
  | "chat.init.phase.finalizing"
  | "chat.init.phase.memory"
  | "chat.init.phase.plugins"
  | "chat.init.phase.preparing"
  | "chat.init.phase.runtime"
  | "chat.init.phase.tts"
  | "chat.init.title"
  | "chat.init.waitingForProgress"
  ...
  | "chat.input.batch"
  | "chat.input.batchCancel"
  | "chat.input.batchCountdown"
  | "chat.input.batchSendNow"
  | "chat.input.batchWaiting"
  ...
  | "chat.input.attachImage"
  | "chat.input.attachmentLimit"
  | "chat.input.attachments"
  | "chat.input.filePickerTitle"
  | "chat.input.imagePickerTitle"
  | "chat.input.moreActions"
  | "chat.input.placeholder"
  | "chat.input.removeAttachment"
  | "chat.input.send"
  | "chat.input.settings"
  | "chat.input.turnControls"
  ...
  | "chat.theme.active"
  | "chat.theme.apply"
  | "chat.theme.backToSettings"
  | "chat.theme.customize"
  | "chat.theme.customizer.align"
  | "chat.theme.customizer.back"
  | "chat.theme.customizer.background"
  | "chat.theme.customizer.baseTheme"
  | "chat.theme.customizer.borderColor"
  | "chat.theme.customizer.borderRadius"
  | "chat.theme.customizer.chrome"
  | "chat.theme.customizer.cloneHint"
  | "chat.theme.customizer.customName"
  | "chat.theme.customizer.decoration"
  | "chat.theme.customizer.description"
  | "chat.theme.customizer.editHint"
  | "chat.theme.customizer.fontFamily"
  | "chat.theme.customizer.fontSize"
  | "chat.theme.customizer.fontWeight"
  | "chat.theme.customizer.gap"
  | "chat.theme.customizer.height"
  | "chat.theme.customizer.idDuplicate"
  | "chat.theme.customizer.idError"
  | "chat.theme.customizer.layout"
  | "chat.theme.customizer.loadError"
  | "chat.theme.customizer.loading"
  | "chat.theme.customizer.maxWidth"
  | "chat.theme.customizer.nameError"
  | "chat.theme.customizer.offsetY"
  | "chat.theme.customizer.overlap"
  | "chat.theme.customizer.padding"
  | "chat.theme.customizer.placement"
  | "chat.theme.customizer.preview"
  | "chat.theme.customizer.previewDialog"
  | "chat.theme.customizer.previewHint"
  | "chat.theme.customizer.previewName"
  | "chat.theme.customizer.previewOptionOne"
  | "chat.theme.customizer.previewOptions"
  | "chat.theme.customizer.previewOptionThree"
  | "chat.theme.customizer.previewOptionTwo"
  | "chat.theme.customizer.previewText"
  | "chat.theme.customizer.reset"
  | "chat.theme.customizer.saved"
  | "chat.theme.customizer.saveError"
  | "chat.theme.customizer.sectionDialog"
  | "chat.theme.customizer.sectionGlobal"
  | "chat.theme.customizer.sectionInput"
  | "chat.theme.customizer.sectionMetadata"
  | "chat.theme.customizer.sectionName"
  | "chat.theme.customizer.sectionOptions"
  | "chat.theme.customizer.sectionTypewriter"
  | "chat.theme.customizer.textColor"
  | "chat.theme.customizer.themeColor"
  | "chat.theme.customizer.themeId"
  | "chat.theme.customizer.title"
  | "chat.theme.customizer.typewriterSpeed"
  | "chat.theme.customizer.version"
  | "chat.theme.customizer.width"
  | "chat.theme.customizer.widthMode"
  | "chat.theme.delete"
  ...
  | "plugin.catalog.downloads"
  | "plugin.catalog.metadataLabel"
  | "plugin.catalog.officialPackage"
  | "plugin.catalog.securityScanPassed"
  | "plugin.catalog.sortDownloads"
  | "plugin.catalog.sortLabel"
  | "plugin.catalog.sortLatest"
  ...
  | "system.asr.modelCached"
  | "system.asr.modelChecking"
  | "system.asr.modelDownload"
  | "system.asr.modelDownloadConfirm"
  | "system.asr.modelDownloadConfirmBody"
  | "system.asr.modelDownloadDescription"
  | "system.asr.modelDownloadFailed"
  | "system.asr.modelDownloadHint"
  | "system.asr.modelDownloadTitle"
  | "system.asr.modelDownloading"
  | "system.asr.modelLocalMissing"
  | "system.asr.modelLocalDescription"
  | "system.asr.modelLocalReady"
  | "system.asr.modelMissing"
  | "system.asr.modelName"
  | "system.asr.modelRepository"
  | "system.asr.modelViewProgress"
  | "system.asr.provider"
  | "system.asr.title"
  | "system.asr.voskHint"
  ...
  | "template.optionHelp"
  | "template.primaryCharacters.confirm"
  | "template.primaryCharacters.configure"
  | "template.primaryCharacters.count"
  | "template.primaryCharacters.description"
  | "template.primaryCharacters.hasBrief"
  | "template.primaryCharacters.modify"
  | "template.primaryCharacters.needsBrief"
  | "template.primaryCharacters.primary"
  | "template.primaryCharacters.statusCompact"
  | "template.primaryCharacters.statusFull"
  | "template.primaryCharacters.statusPending"
  | "template.primaryCharacters.title"
  | "template.primaryCharacters.useAll"
  | "template.mobileAccessHint"
  ...
  | "template.semanticMedia.error"
  | "template.semanticMedia.hint"
  | "template.semanticMedia.label"
  | "template.semanticMedia.preparing"
  ...
  | "effect.action.saveImageTags"
  | "effect.action.uploadContribution"
  | "effect.asset.addAudio"
  | "effect.asset.batchInsertAudio"
  | "effect.asset.batchInsertAudioComplete"
