...
export type MessageKey =
  ...
  | "template.validation.storyRequired"
  | "template.field.playMode"
  | "template.playMode.free"
  | "template.playMode.freeHint"
  | "template.playMode.openCreator"
  | "template.playMode.openEditor"
  | "template.playMode.selectStory"
  | "template.playMode.selectStoryPlaceholder"
  | "template.playMode.noStories"
  | "template.playMode.story"
  | "template.playMode.storyCast"
  | "template.playMode.graphTitle"
  | "template.playMode.graphLoading"
  | "template.playMode.storyHint"
  | "mention.empty"
  | "mention.listLabel"
  | "mention.user"
  | "story.editor.addChoice"
  | "story.editor.addCharacter"
  | "story.editor.addEffect"
  | "story.editor.addNode"
  | "story.editor.addRule"
  | "story.editor.addSignal"
  | "story.editor.addVariable"
  | "story.editor.aiApply"
  | "story.editor.aiGenerate"
  | "story.editor.aiInstruction"
  | "story.editor.aiPlaceholder"
  | "story.editor.aiProposal"
  | "story.editor.aiTitle"
  | "story.editor.backToGenerator"
  | "story.editor.castEmpty"
  | "story.editor.castMode"
  | "story.editor.castMode.dynamic"
  | "story.editor.castMode.fixed"
  | "story.editor.castMode.mixed"
  | "story.editor.castMode.roleBased"
  | "story.editor.castPreview"
  | "story.editor.castRequired"
  | "story.editor.castSelected"
  | "story.editor.castTitle"
  | "story.editor.choiceGoto"
  | "story.editor.choiceLabel"
  | "story.editor.choiceTarget"
  | "story.editor.choices"
  | "story.editor.confidence.high"
  | "story.editor.confidence.low"
  | "story.editor.confidence.medium"
  | "story.editor.commitment"
  | "story.editor.commitment.committed"
  | "story.editor.commitment.draft"
  | "story.editor.commitment.frozen"
  | "story.editor.delete"
  | "story.editor.diagnostics"
  | "story.editor.diagnosticSuggestion"
  | "story.editor.diagnosticsLoading"
  | "story.editor.diagnosticsPass"
  | "story.editor.draftPublished"
  | "story.editor.effectAmount"
  | "story.editor.effectCount"
  | "story.editor.enterCondition"
  | "story.editor.enterEffects"
  | "story.editor.enterWhen"
  | "story.editor.enterWhenPlaceholder"
  | "story.editor.endings"
  | "story.editor.eyebrow"
  | "story.editor.finalNode"
  | "story.editor.graphEdges"
  | "story.editor.graphTitle"
  | "story.editor.loading"
  | "story.editor.maxActive"
  | "story.editor.missingId"
  | "story.editor.newChoice"
  | "story.editor.newScene"
  | "story.editor.nodeTitle"
  | "story.editor.nodeType"
  | "story.editor.nodeType.ending"
  | "story.editor.nodeType.story"
  | "story.editor.nodes"
  ...
  | "story.editor.remove"
  | "story.editor.ruleType"
  | "story.editor.rules"
  | "story.editor.selectNode"
  | "story.editor.selectedNode"
  | "story.editor.signalId"
  | "story.editor.signals"
  | "story.editor.sourceMap"
  | "story.editor.step"
  | "story.editor.undo"
  | "story.editor.validate"
  | "story.editor.variableId"
  | "story.editor.variableType.boolean"
  | "story.editor.variableType.enum"
  | "story.editor.variableType.integer"
  | "story.editor.variableType.stringSet"
  | "story.editor.variables"
  | "story.editor.variablesTitle"
  | "story.editor.validationFailed"
  | "story.editor.validationPassed"
  | "story.generator.assumptions"
  | "story.generator.assumptionsEmpty"
  | "story.generator.cancel"
  | "story.generator.castFailures"
  | "story.generator.description"
  | "story.generator.endingCoverage"
  | "story.generator.estimatedTokens"
  | "story.generator.exploredStates"
  | "story.generator.eyebrow"
  | "story.generator.generating"
  | "story.generator.openDraftHint"
  | "story.generator.openEditor"
  | "story.generator.placeholder"
  | "story.generator.progress"
  | "story.generator.progressMeta"
  | "story.generator.regenerate"
  | "story.generator.regenerateHint"
  | "story.generator.regenerateStage"
  | "story.generator.regenerateTitle"
  | "story.generator.resume"
  | "story.generator.stage.bible"
  | "story.generator.stage.characters"
  | "story.generator.stage.logic"
  | "story.generator.stage.narrative"
  | "story.generator.stage.requirements"
  | "story.generator.stage.resources"
  | "story.generator.stage.state"
  | "story.generator.start"
  | "story.generator.synopsis"
  | "story.generator.title"
  | "story.generator.validation"
  | "story.generator.validationEmpty"
  | "story.generator.validationFailed"
  | "story.generator.validationPassed"
  | "story.generator.validationRepairFailed"
  | "story.generator.validationSuggestion"
  | "top.chatStage"
  | "tools.browse"
  | "tools.character"
  | "tools.cropBtn"
