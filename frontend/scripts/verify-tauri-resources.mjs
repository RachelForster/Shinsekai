...
await assertExists(path.join(resourcesDir, "config", "models", "schema.py"));
await assertExists(path.join(resourcesDir, "config", "models", "feature_flags.py"));
await assertExists(path.join(resourcesDir, "config", "models", "network_proxy.py"));
await assertExists(path.join(resourcesDir, "config", "models", "adapter_extra_kwargs.py"));
await assertExists(path.join(resourcesDir, "config", "models", "llm_defaults.py"));
await assertExists(path.join(resourcesDir, "config", "models", "sprite_voice.py"));
await assertExists(path.join(resourcesDir, "config", "persistence", "config_manager.py"));
await assertExists(path.join(resourcesDir, "config", "persistence", "character_manager.py"));
await assertExists(path.join(resourcesDir, "config", "persistence", "background_manager.py"));
await assertExists(path.join(resourcesDir, "config", "persistence", "character_config.py"));
await assertExists(path.join(resourcesDir, "config", "persistence", "mcp_config.py"));
